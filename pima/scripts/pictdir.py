...
# *                                                                      *
# * ### 22-NOV-2023   pictdir.py   v 1.1 (d)  L. Petrov 21-FEB-2026  ### *
# *                                                                      *
# ************************************************************************
"""
...
pictdir__version = "pictdir.py v 1.2  20260525"

#
# ------------------------------------------------------------------------
#
def pictdir_exe ( ima_dir, box_size, verb ):
    ...
    for map_fits_file in map_list:
        ...
        if ( box_size >= 0.0  ):
             map_opt = "-box %10.5f" % box_size

#
# ----- Generates gif-image
#
        com = "fits_to_map -auto -o " + map_gif_file + " " + map_opt + " " + map_fits_file
        if ( verb > 2 ):
...
#
    ...
    parser.add_argument ( "-b", "--box-size", action="store", \
                          dest="box", \
                          default=-1.0, \
                          metavar="value", \
                          type=float, \
                          help="Box size in mas" )
#
...
#
    ...
    num_ima = pictdir_exe ( args.dir, args.box, args.verb )
