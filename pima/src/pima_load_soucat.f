...
! *                                                                      *
! * ### 07-JAN-2006 PIMA_LOAD_SOUCAT v4.3 (d)  L. Petrov 15-DEC-2023 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'pima.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 21-JAN-2004  PIMA_READ_SOU  v4.0 (d)  L. Petrov  18-DEC-2022 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'pima_getpar.i'
...
!
     ...
     &    '# VLBI SOURCE POSITION CATALOGUE  Format version of 2004.08.20' ) THEN
         ...
         ELSE IF ( BUF(1)(1:32) == '# SOURCE-NAMES  v 2.1 2022.07.24' ) THEN
           MODE = 6
         ELSE IF ( BUF(1)(1:32) == '# SOURCE-NAMES  v 3.0 2025.09.06' ) THEN
           MODE = 7
         ELSE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 03-DEC-2001  PIMA_READ_SOU_LINE   v3.1 (d) L. Petrov 28-JUL-2006 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
!
           ...
           SOUCAT%NSES_USED = 1
         ELSE IF ( MODE .EQ. 4 .OR. MODE .EQ. 7 ) THEN
           SOUCAT%CALIB = 1
