...
! ************************************************************************
! *                                                                      *
! *   Routine PIMA_FIND_SUB finds all subarrays that correspond to       *
...
! *                                                                      *
! *  ### 06-AUG-2013  PIMA_FIND_SUB  v3.3 (d) L. Petrov 23-FEB-2026 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
      DO 4130 J13=1,PIM%L_SUB
         IF ( PIM%SUB%L_STA(J13) == 0 ) THEN
              CALL CLRCH ( STR )
              CALL INCH  ( J13, STR )
              CALL ERR_LOG ( 7824, IUER, 'PIMA_FUND_SUB', 'Trap of internal '// &
