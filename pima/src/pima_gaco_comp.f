...
! *                                                                      *
! * ### 23-FEB-2016  PIMA_GACO_COMP  v1.2 (d) L. Petrov 12-MAR-2026 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'pima.i'
...
!
     ...
     &                      ABS(UVS_VIS%VIS(J12,IND_UVA_XREF(J10))) > PIMA__AMP_MIN .AND. &
     &                      ABS(UVS_VIS%VIS(J12,IND_UVA_XREF(J10))) < PIMA__AMP_MAX       ) THEN
!
