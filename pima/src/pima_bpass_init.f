...
! *                                                                      *
! * ### 25-JAN-2009  PIMA_BPASS_INIT v5.0 (d) L. Petrov  06-NOV-2020 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
!
      DO 420 J2=1,PIM%NSTA
         ...
         IF ( PIM%BPS%NUM_OBS_ACCUM(J2) > 0 ) THEN
              PIM%BPS%PCI(J2) = PIMA__PCI_PAR
            ELSE IF ( PIM%BPS%NUM_OBS_ACCUM(J2) > 0 ) THEN
...
!
         IF ( PCI < 1 ) GOTO 420
         DO 430 J3=1,PIM%BPS%NUM_OBS_ACCUM(J2) 
            IND_OBS = PIM%BPS%IND_OBS_SEL(J3,J2)
