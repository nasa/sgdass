...
! *                                                                      *
! *  ### 12-FEB-2007     GET_BAND  v1.1 (d)  L. Petrov  2008.06.12  ###  *
! *                                                                      *
! ************************************************************************
      CHARACTER  GET_BAND*(*)
      REAL*8     FREQ
!
      IF ( FREQ .GT. 120.D9 .AND. FREQ .LE. 132.D9 ) THEN
           GET_BAND = 'W'
         ELSE IF ( FREQ .GT. 80.D9 .AND. FREQ .LE. 92.D9 ) THEN
           GET_BAND = 'W'
         ELSE IF ( FREQ .GT. 40.D9 .AND. FREQ .LE. 60.D9 ) THEN
           GET_BAND = 'Q'
         ...
         ELSE IF ( FREQ .GT.  6.5D9  .AND.  FREQ .LE. 11.0D9 ) THEN
           GET_BAND = 'X'
         ELSE IF ( FREQ .GT.  3.8D9  .AND.  FREQ .LE. 6.5D9 ) THEN
           GET_BAND = 'C'
         ELSE IF ( FREQ .GT.  1.8D9  .AND.  FREQ .LE. 3.8D9 ) THEN
           GET_BAND = 'S'
         ELSE IF ( FREQ .GT.  0.1D9  .AND.  FREQ .LE. 1.8D9 ) THEN
           GET_BAND = 'L'
         ELSE 
           GET_BAND = '?'
      END IF
