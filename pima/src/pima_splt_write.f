...
! *                                                                      *
! * ### 02-APR-2011 PIMA_SPLT_WRITE v3.5 (d)  L. Petrov  23-FEB-2026 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
     ...
     &     PIM%CONF%SPLT_POLAR == PIMA__POLAR_ALI      ) THEN
           M_POL  = PIM%NSTK
         ELSE 
           M_POL  = 1
      END IF
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 24-FEB-2011  FFITS_PUT_KEYS  v1.7 (d)  L. Petrov 28-FEB-2016 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'astro_constants.i'
            ...
            ELSE IF ( INDEX ( BUF(J5), '@STOKES_DELTA__@' ) > 0 ) THEN
              IF ( PIM%CONF%SPLT_POLAR == PIMA__POLAR_PAR ) THEN
                 ...
                 ELSE IF ( PIM%CONF%SPLT_POLAR == PIMA__POLAR_ALL ) THEN
                   BUF(J5)(18:33) = '-1.0000000000000'
                 ELSE IF ( PIM%CONF%SPLT_POLAR == PIMA__POLAR_ALI ) THEN
                   BUF(J5)(18:33) = '-1.0000000000000'
