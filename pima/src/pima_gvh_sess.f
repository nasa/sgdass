...
! *                                                                      *
! * ### 10-JUL-2009  PIMA_GVH_SESS   v1.4 (d)  L. Petrov 24-NOV-2019 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'pima.i'
...
!
           DO 4120 J12=1,PIM%NSTA
              IF ( PIM%STA(J12)%CABLE(PIM%CONF%FRQ_GRP)%CAB_AVAIL .AND. &
     &             PIM%STA(J12)%CABLE(PIM%CONF%FRQ_GRP)%NPOI > 0        ) THEN
                   MEAN_CABLE(J12) = PIM%STA(J12)%CABLE(PIM%CONF%FRQ_GRP)%MEAN_CABLE
                   CAB_SIGN(J12)   = PIM%STA(J12)%CABLE(PIM%CONF%FRQ_GRP)%CABLE_SIGN
                 ELSE
