...
! *                                                                      *
! * ### 24-MAY-2006 PIMA_READ_BPASS  v1.8 (d) L. Petrov  11-DEC-2020 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'pima.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ## 27-JAN-2009 PIMA_READ_BPASS_STA v2.4 (d) L. Petrov 11-DEC-2020 ## *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'pima.i'
...
!
                   IF ( ASSOCIATED ( PIM%BPASS ) ) THEN
                        DO 520 J2=1,PIM%NSTA
                           IF ( ASSOCIATED ( PIM%BPASS(J2)%AMP_RMS_FRQ   ) ) DEALLOCATE ( PIM%BPASS(J2)%AMP_RMS_FRQ )
                           IF ( ASSOCIATED ( PIM%BPASS(J2)%PHS_RMS_FRQ   ) ) DEALLOCATE ( PIM%BPASS(J2)%PHS_RMS_FRQ )
                           IF ( ASSOCIATED ( PIM%BPASS(J2)%BPS           ) ) DEALLOCATE ( PIM%BPASS(J2)%BPS )
                           IF ( ASSOCIATED ( PIM%BPASS(J2)%FREQ          ) ) DEALLOCATE ( PIM%BPASS(J2)%FREQ )
                           IF ( ASSOCIATED ( PIM%BPASS(J2)%PHS_RATE      ) ) DEALLOCATE ( PIM%BPASS(J2)%PHS_RATE )
                           IF ( ASSOCIATED ( PIM%BPASS(J2)%SPLT_NRML_FRQ ) ) DEALLOCATE ( PIM%BPASS(J2)%SPLT_NRML_FRQ )
 520                    CONTINUE 
!
