...
! *                                                                      *
! * ## 12-DEC-2015 PIMA_LOAD_KJCC_MOD v1.1 (d) L. Petrov 19-DEC-2025 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      ...
      INTEGER*4  IUER
      CHARACTER  FINAM*128, MDU_FILE*128, STR*128, ERRSTR*128
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ## 13-DEC-2015 PIMA_PARSE_KJCC_MOD v1.0 (d) L. Petrov 13-DEC-2015 ## *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'pima.i'
