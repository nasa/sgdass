...
! *                                                                      *
! * ### 19-AUG-2010  PIMA_READ_PBP   v2.3 (d) L. Petrov  08-MAY-2019 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'pima.i'
...
!
                   IF ( ASSOCIATED ( PIM%PBP ) ) THEN
                        DO 520 J2=1,PIM%NSTA
                           IF ( ASSOCIATED ( PIM%PBP(J2)%CMPL          ) ) DEALLOCATE ( PIM%PBP(J2)%CMPL )
                           IF ( ASSOCIATED ( PIM%PBP(J2)%SPLT_NRML_FRQ ) ) DEALLOCATE ( PIM%PBP(J2)%SPLT_NRML_FRQ )
 520                    CONTINUE 
                        DEALLOCATE ( PIM%PBP )
                   END IF
!
