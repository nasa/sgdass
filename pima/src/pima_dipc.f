...
! *                                                                      *
! *  ### 15-DEC-2010   PIMA_DIPC   v1.1 (d)  L. Petrov  06-APR-2014 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
      DO 410 J1=1,PIM%NSTA
         ...
         PIM%STA(J1)%CABLE(PIM%CONF%FRQ_GRP)%CAB_AVAIL  = .FALSE.
         ...
         IF ( ASSOCIATED ( PIM%STA(J1)%CABLE(PIM%CONF%FRQ_GRP)%CAB_DEL     ) ) DEALLOCATE ( PIM%STA(J1)%CABLE(PIM%CONF%FRQ_GRP)%CAB_DEL     )
 410  CONTINUE 
!
      DO 420 J2=1,2
...
!
 ...
 4100    CONTINUE 
         ...
         PIM%STA(J9)%CABLE(PIM%CONF%FRQ_GRP)%CAB_AVAIL = .FALSE.
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 14-DEC-2010 DIFX_PCAL_PARSE v1.0 (d)  L. Petrov  15-DEC-2010 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      CHARACTER  PCAL_FIL*(*)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 16-DEC-2010   DOY_TO_TIM  v1.0 (d)  L. Petrov  16-DEC-2010 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'pima.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 19-DEC-2010    PCAL_MOD   v1.0 (d)  L. Petrov  19-DEC-2010 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'astro_constants.i'
