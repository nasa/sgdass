...
#
def l2b_sub_B  ( exp_type, tim_delt, fil_log_path, pid ):
    ...
    25-MAR-2024  l2b_sub.py    v2.0 (c) N. Habana
    """
#
...
#       else:
          ...
          ln        = len ( split_log )
#
# ------- We expect the end to be a log file.
#
...
# -------
             ...
             print ( "%s already exists, no temp file generated " )
