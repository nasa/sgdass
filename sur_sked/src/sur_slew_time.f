...
! *                                                                      *
! * ### 19-JAN-2008  SUR_SLEW_TIME  v4.7 (d)  L. Petrov  31-MAR-2026 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
     ...
     &           A_LAST, B_LAST, ALP, DEL, DIST_AZ_1ST(SUR__M_STA), TIM_LO
      REAL*8     AZ_SAVE(SUR__M_STA), EL_SAVE(SUR__M_STA), HA_SAVE(SUR__M_STA)
      LOGICAL*1  FL_VIS(SUR__M_STA)
...
!
            IER = -1
            FL_CHECK = SUR_CHECK_VIS ( SUR, J2, CUR_TYP, IND_SRC, AZ, EL, HA, IER ) 
