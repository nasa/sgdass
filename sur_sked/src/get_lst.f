...
! *                                                                      *
! *  ### 06-JUN-2010     GET_LST   v1.0 (d)  L. Petrov  2018.06.01  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
 ...
 410  CONTINUE 
     ...
     &          STA_NAM(1:I_LEN(STA_NAM))//' was not scheduled' )
      ...
      END IF
!
      IF ( VTD%NERS%FCS_STATUS == NERS__UNDF .OR. &
     &     VTD%NERS%FCS_STATUS == NERS__CLEA      ) THEN
!
...
!
     ...
     &                   IER )
           IF ( IER .NE. 0 ) THEN
                CALL ERR_LOG ( 1742, IUER, 'GET_LST', 'Error in an attempt '// &
