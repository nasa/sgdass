...
! *                                                                      *
! *  ### 19-NOV-2005  SUR_CHECK_VIS  v1.8 (d) L. Petrov 31-MAR-2026 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
 ...
 440       CONTINUE 
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_KASHIMA(3,J5)       ) THEN
              ...
              END IF
 450       CONTINUE 
         ELSE IF ( STA_NAM == 'BR-VLBA ' .OR. STA_NAM == 'VLBA_BR ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_BR(3,J6)       ) THEN
              ...
              END IF
 460       CONTINUE 
         ELSE IF ( STA_NAM == 'FD-VLBA ' .OR. STA_NAM == 'VLBA_FD ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_FD(3,J7)       ) THEN
              ...
              END IF
 470       CONTINUE 
         ELSE IF ( STA_NAM == 'HN-VLBA ' .OR. STA_NAM == 'VLBA_HN ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_HN(3,J8)       ) THEN
              ...
              END IF
 480       CONTINUE 
         ELSE IF ( STA_NAM == 'KP-VLBA ' .OR. STA_NAM == 'VLBA_KP ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_KP(3,J9)       ) THEN
              ...
              END IF
 490       CONTINUE 
         ELSE IF ( STA_NAM == 'LA-VLBA ' .OR. STA_NAM == 'VLBA_LA ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_LA(3,J10)       ) THEN
              ...
              END IF
 4100       CONTINUE 
         ELSE IF ( STA_NAM == 'MK-VLBA ' .OR. STA_NAM == 'VLBA_MK ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_MK(3,J11)       ) THEN
              ...
              END IF
 4110       CONTINUE 
         ELSE IF ( STA_NAM == 'NL-VLBA ' .OR. STA_NAM == 'VLBA_NL ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_NL(3,J12)       ) THEN
              ...
              END IF
 4120       CONTINUE 
         ELSE IF ( STA_NAM == 'OV-VLBA ' .OR. STA_NAM == 'VLBA_OV ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_OV(3,J13)       ) THEN
              ...
              END IF
 4130       CONTINUE 
         ELSE IF ( STA_NAM == 'PIETOWN ' .OR. STA_NAM == 'VLBA_PT ' ) THEN
     ...
     &             EL/DEG__TO__RAD .LT. AZELHOR_PT(3,J14)       ) THEN
              ...
              END IF
 4140       CONTINUE 
         ELSE IF ( STA_NAM == 'SC-VLBA ' .OR. STA_NAM == 'VLBA_SC ' ) THEN
