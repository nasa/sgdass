...
!  >>>> 2005.10.10   L. Petrov  2026.01.27_19:46:49
!
     ...
     &               FRQ_SEQ__LABEL*32, SUR__SAT__LABEL*58
        PARAMETER  ( SUR__LABEL = 'Sur_sked  Version of 20260818' )
...
!
	...
	PARAMETER  ( SUR__M_SOU = 510*1024 )
	PARAMETER  ( SUR__M_SCN = 8192 )
	PARAMETER  ( SUR__M_EPC = 8192 )
...
!
! --------- Block for a case when a stations is on the orbit
!
            INTEGER*4  N_EPC
...
!
	   ...
	   INTEGER*4  L_OBS_POC
	   INTEGER*4  L_OBS_PLA
	   INTEGER*4  SRC_TYP(SUR__M_SCN)
	   INTEGER*4  IND_SRC(SUR__M_SCN)
