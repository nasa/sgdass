...
" Station:      KOKEE12M   K2 
"
" Template last modification date: 2025.03.31_12:30:47
...
" set lo: lo=loa0,@lo@,usb,lcp,5
" set lo: lo=loa1,@lo@,usb,rcp,5
" set lo: lo=lob0,@lo@,usb,lcp,5
" set lo: lo=lob1,@lo@,usb,rcp,5
" set lo: lo=loc0,@lo@,usb,lcp,5
" set lo: lo=loc1,@lo@,usb,rcp,5
" set lo: lo=lod0,@lo@,usb,lcp,5
" set lo: lo=lod1,@lo@,usb,rcp,5
" set the udc
sy=popen 's_client -h udca -c udc_lo=@udc_lo@   2>&1' -n udcca
sy=popen 's_client -h udcb -c udc_lo=@udc_lo@   2>&1' -n udccb
sy=popen 's_client -h udcc -c udc_lo=@udc_lo@   2>&1' -n udccc
sy=popen 's_client -h udcd -c udc_lo=@udc_lo@   2>&1' -n udccd
"
