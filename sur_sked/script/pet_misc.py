import  sys, os, subprocess, signal, time, datetime, gzip, bz2, lzma, inspect
...
def get_cdl():
    ...
    return ( "%s,Line:%d" % ( os.path.basename(filename), line_number ) )
#
# ------------------------------------------------------------------------
#   
def where_error():
    ...
    return ( "ERROR(%s,Line:%d)" % ( os.path.basename(filename), line_number ) )
#
# ------------------------------------------------------------------------
#   
def where_info ():
    ...
    return ( "INFO(%s,Line:%d)" % ( os.path.basename(filename), line_number ) )
