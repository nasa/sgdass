#include <mk5_preprocessor_directives.inc>
      PROGRAM    BPSD_UTIL_MAIN
! ************************************************************************
! *                                                                      *
! *   Program BPSD_UTIL_MAIN
! *                                                                      *
! *  ### 19-NOV-2024 BPSD_UTIL_MAIN v1.0 (c)  L. Petrov 19-NOV-2024 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
      IF ( IARGC() < 2 ) THEN
           WRITE ( 6, * ) 'Usage: bspd_util check|truncate|extract|extend bspd_file|bspd_dir param'
           CALL  EXIT ( 1 )
         ELSE 
           CALL GETARG ( 1, MODE     )
