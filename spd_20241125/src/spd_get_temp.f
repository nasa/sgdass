      FUNCTION SPD_GET_TEMP ( SPD, MAT_XI_TO_X3, VEC_GROUND_XYZ, &
     &                        VEC_XI, IUER )
! ************************************************************************
! *                                                                      *
! *   FUNCTION SPD_GET_TEMP
! *                                                                      *
! * ### 11-SEP-2014   SPD_GET_TEMP   v3.0 (c) L. Petrov  11-SEP-2014 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
     ...
     &         'internal control: error in computing pivotal index' )
      ...
      END IF
!
      SPD_GET_TEMP = VAL_3D_BSPLE3 ( ARGS, DIMS, INDS, &
     &                               SPD%LEV,  &
     &                               SPD%LON,  &
     &                               SPD%LAT,  &
     &                               SPD%STM_3D(1-SPD__MDEG,1-SPD__MDEG,1-SPD__MDEG) &
     &                             )
!
      CALL ERR_LOG ( 0, IUER )
      RETURN
      END  FUNCTION  SPD_GET_TEMP  !#!#
