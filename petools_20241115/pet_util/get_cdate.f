...
! ------------------------------------------------------------------------
!
      FUNCTION   GET_TZ_CDATE ( )
! ************************************************************************
! *                                                                      *
! *   Routine  GET_TZ_CDATE learns the current system time and           *
! *   transforms it to yyyy.mm.dd-hh:mm:ss zz:zz format like             *
! *   1999.09.02-20:54:45 +04:00                                         *
! *                                                                      *
! *   The length of the line is 26 symbols.                              *
! *                                                                      *
! * ###  31-OCT-2019  GET_TZ_CDATE  v1.0 (c) L. Petrov  31-OCT-2019 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      CHARACTER  GET_TZ_CDATE*26
      CHARACTER  STR*32
      INTEGER*4  TIM_VAL(8), ITZ_HR, ITZ_MN
!
      CALL DATE_AND_TIME ( VALUES=TIM_VAL )
!
      WRITE ( UNIT=STR, FMT='(I4,".",I2,".",I2,"-",I2,":",I2,":",I2)' ) &
     &        TIM_VAL(1), TIM_VAL(2), TIM_VAL(3), TIM_VAL(5), TIM_VAL(6), &
     &        TIM_VAL(7)
!
      CALL BLANK_TO_ZERO ( STR(1:19) )
      IF ( TIM_VAL(4) < 0 ) THEN
           STR(20:21) = ' -'
           TIM_VAL = -TIM_VAL
         ELSE
      ...
      END IF
      ITZ_HR = TIM_VAL(4)/60
      ITZ_MN = TIM_VAL(4) - 60*ITZ_HR 
      WRITE ( UNIT=STR(22:26), FMT='(I2,":"I2)' ) ITZ_HR, ITZ_MN 
      CALL BLANK_TO_ZERO ( STR(22:26) )
      GET_TZ_CDATE = STR
!
      RETURN
      END  FUNCTION  GET_TZ_CDATE  !#!#
!
! ------------------------------------------------------------------------
!
      FUNCTION   GET_UTC_CDATE ( )
! ************************************************************************
! *                                                                      *
! *   Routine  GET_UTC_CDATE learns the current system UTC time tag and  *
...
! *   The length of the line is 19 symbols.                              *
! *                                                                      *
! * ### 31-OCT-2019  GET_UTC_CDATE  v1.0  (c) L. Petrov  31-OCT-2019 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      CHARACTER  GET_UTC_CDATE*19
      CHARACTER  STR*32
      INTEGER*4  TIM_VAL(8)
!
      CALL GET_HR_UTC ( TIM_VAL )
!
      WRITE ( UNIT=GET_UTC_CDATE, FMT='(I4,".",I2,".",I2,"-",I2,":",I2,":",I2)' ) TIM_VAL(1:6)
      CALL BLANK_TO_ZERO ( GET_UTC_CDATE )
!
      RETURN
      END  !#!  GET_UTC_CDATE  #!#
!
...
! *   The length of the line is 29 symbols.                              *
! *                                                                      *
! * ### 11-AUG-2015 GET_HR_UTC_CDATE v1.0 (c) L. Petrov  31-AUG-2014 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
