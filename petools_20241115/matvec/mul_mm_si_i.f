#ifdef GEN_PREFIX
#define FUNC_MUL_MM_SI_I  GEN_MUL_MM_SI_I
#else
#define FUNC_MUL_MM_SI_I  OPT_MUL_MM_SI_I
#endif
#include <mk5_preprocessor_directives.inc>
      SUBROUTINE FUNC_MUL_MM_SI_I ( M1, MAT1, M2, N2, MAT2, M3, N3, MATO, &
     &                              IUER )
! ************************************************************************
! *                                                                      *
! *   Subroutine  MUL_MM_SI_I  multiplies matrices:                      *
! *   MATO = MAT1 * MAT2                                                 *
! *                                                                      *
! *   MAT1 -- symmetric matrix in the upper triangular representation;   *
! *   MAT2 -- rectangular matrix;                                        *
! *   MATO -- rectangular matrix.                                        *
! *                                                                      *
! *  ###  09-DEC-1996  MUL_MM_SI_I  v6.1 (c)  L. Petrov 29-DEC-2021 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
!
      IF ( M1 .EQ. 2 ) THEN
           DO 510 J1=1,N3
              MATO(1,J1) = MAT1(1)*MAT2(1,J1) + MAT1(2)*MAT2(2,J1)
              MATO(2,J1) = MAT1(2)*MAT2(1,J1) + MAT1(3)*MAT2(2,J1) 
 510       CONTINUE 
     ...
     &                     MAT1(4)*MAT2(3,J1) 
              MATO(2,J1) = MAT1(2)*MAT2(1,J1) + MAT1(3)*MAT2(2,J1) + &
     &                     MAT1(5)*MAT2(3,J1) 
              MATO(3,J1) = MAT1(4)*MAT2(1,J1) + MAT1(5)*MAT2(2,J1) + &
     &                     MAT1(6)*MAT2(3,J1) 
 520       CONTINUE 
        ELSE IF ( M1 .EQ. 4 ) THEN
           DO 530 J1=1,N3
              MATO(1,J1) = MAT1(1)*MAT2(1,J1) + MAT1(2)*MAT2(2,J1) + &
     &                     MAT1(4)*MAT2(3,J1) + MAT1(7)*MAT2(4,J1) 
              MATO(2,J1) = MAT1(2)*MAT2(1,J1) + MAT1(3)*MAT2(2,J1) + &
     &                     MAT1(5)*MAT2(3,J1) + MAT1(8)*MAT2(4,J1) 
              MATO(3,J1) = MAT1(4)*MAT2(1,J1) + MAT1(5)*MAT2(2,J1) + &
     &                     MAT1(6)*MAT2(3,J1) + MAT1(9)*MAT2(4,J1) 
              MATO(4,J1) = MAT1(7)*MAT2(1,J1) + MAT1(8)*MAT2(2,J1) + &
     &                     MAT1(9)*MAT2(3,J1) + MAT1(10)*MAT2(4,J1) 
 530       CONTINUE 
     ...
     &                     MAT1(9)*MAT2(3,J1) + MAT1(10)*MAT2(4,J1) + &
     &                     MAT1(14)*MAT2(5,J1) 
              MATO(5,J1) = MAT1(11)*MAT2(1,J1) + MAT1(12)*MAT2(2,J1) + &
     &                     MAT1(13)*MAT2(3,J1) + MAT1(14)*MAT2(4,J1) + &
     &                     MAT1(15)*MAT2(5,J1) 
 540       CONTINUE 
        ELSE IF ( M1 .EQ. 6 ) THEN
           DO 550 J1=1,N3
              MATO(1,J1) = MAT1(1)*MAT2(1,J1)  + MAT1(2)*MAT2(2,J1)  + &
     &                     MAT1(4)*MAT2(3,J1)  + MAT1(7)*MAT2(4,J1)  + &
     &                     MAT1(11)*MAT2(5,J1) + MAT1(16)*MAT2(6,J1) 
              MATO(2,J1) = MAT1(2)*MAT2(1,J1)  + MAT1(3)*MAT2(2,J1)  + &
     &                     MAT1(5)*MAT2(3,J1)  + MAT1(8)*MAT2(4,J1)  + &
     &                     MAT1(12)*MAT2(5,J1) + MAT1(17)*MAT2(6,J1) 
              MATO(3,J1) = MAT1(4)*MAT2(1,J1)  + MAT1(5)*MAT2(2,J1)  + &
     &                     MAT1(6)*MAT2(3,J1)  + MAT1(9)*MAT2(4,J1)  + &
     &                     MAT1(13)*MAT2(5,J1) + MAT1(18)*MAT2(6,J1) 
              MATO(4,J1) = MAT1(7)*MAT2(1,J1)  + MAT1(8)*MAT2(2,J1)  + &
     &                     MAT1(9)*MAT2(3,J1)  + MAT1(10)*MAT2(4,J1) + &
     &                     MAT1(14)*MAT2(5,J1) + MAT1(19)*MAT2(6,J1) 
              MATO(5,J1) = MAT1(11)*MAT2(1,J1) + MAT1(12)*MAT2(2,J1) + &
     &                     MAT1(13)*MAT2(3,J1) + MAT1(14)*MAT2(4,J1) + &
     &                     MAT1(15)*MAT2(5,J1) + MAT1(20)*MAT2(6,J1) 
              MATO(6,J1) = MAT1(16)*MAT2(1,J1) + MAT1(17)*MAT2(2,J1) + &
     &                     MAT1(18)*MAT2(3,J1) + MAT1(19)*MAT2(4,J1) + &
     &                     MAT1(20)*MAT2(5,J1) + MAT1(21)*MAT2(6,J1) 
 550       CONTINUE 
     ...
     &                     MAT1(20)*MAT2(5,J1) + MAT1(21)*MAT2(6,J1) + &
     &                     MAT1(27)*MAT2(7,J1)
              MATO(7,J1) = MAT1(22)*MAT2(1,J1) + MAT1(23)*MAT2(2,J1) + &
     &                     MAT1(24)*MAT2(3,J1) + MAT1(25)*MAT2(4,J1) + &
     &                     MAT1(26)*MAT2(5,J1) + MAT1(27)*MAT2(6,J1) + &
     &                     MAT1(28)*MAT2(7,J1)
 560       CONTINUE 
        ELSE IF ( M1 .LE. DB1__MUL_MM_SI_I ) THEN
!
! -------- Small dimensions
!
           DO 410 J1=1,N3 
              MATO(1,J1) = MAT1(1)*MAT2(1,J1)
              K = 2
              DO 420 J2=2,M1
                 S = 0.0D0
                 DO 430 J3=1,J2-1
                    MATO(J3,J1) = MATO(J3,J1) + MAT1(K)*MAT2(J2,J1)
                    S = S + MAT1(K)*MAT2(J3,J1)
                    K = K+1
 430             CONTINUE
                 MATO(J2,J1) = S + MAT1(K)*MAT2(J2,J1)
                 K = K+1
 420          CONTINUE
 410       CONTINUE
...
!
           ...
           IF ( IERR .NE. 0 ) THEN
                ...
                CALL ERR_LOG ( 18, IUER, 'MUL_MM_SI_I', 'Failure to '// &
...
!
           ...
           CALL DGEMM ( 'N', 'N', M1, N2, M2, 1.D0, MAT1C, &
...
!
!
           IP1 = M3/DB3__MUL_MM_SI_I 
           IF ( IP1*DB3__MUL_MM_SI_I .LT. M3 ) IP1 = IP1 + 1
           IP2 = N3/DB3__MUL_MM_SI_I 
           IF ( IP2*DB3__MUL_MM_SI_I .LT. N3 ) IP2 = IP2 + 1
...
!
           ALLOCATE ( MAT1C(DB3__MUL_MM_SI_I,DB3__MUL_MM_SI_I,NTHR), &
     &                MAT2C(DB3__MUL_MM_SI_I,DB3__MUL_MM_SI_I,NTHR), &
     &                MAT3C(DB3__MUL_MM_SI_I,DB3__MUL_MM_SI_I,NTHR), &
     &                STAT=IERR )
           IF ( IERR .NE. 0 ) THEN
                CALL CLRCH ( STR )
                CALL IINCH ( 8*3*DB3__MUL_MM_SI_I*DB3__MUL_MM_SI_I*NTHR, STR )
                CALL ERR_LOG ( 20, IUER, 'MUL_MM_SI_I', 'Failure to '// &
     &              'allocate '//STR(1:I_LEN(STR))//' bytes of dynamic '// &
     &              'memory' )
                RETURN 
           END IF
...
#ifdef BLAS_NOT_A_NUMBER
           CALL MEMSET ( MAT1C, 0, %VAL(8*DB3__MUL_MM_SI_I*DB3__MUL_MM_SI_I*NTHR) )
           CALL MEMSET ( MAT2C, 0, %VAL(8*DB3__MUL_MM_SI_I*DB3__MUL_MM_SI_I*NTHR) )
           CALL MEMSET ( MAT3C, 0, %VAL(8*DB3__MUL_MM_SI_I*DB3__MUL_MM_SI_I*NTHR) )
#endif
!
           IND_2 = 1
           DO 440 J4=1,IP2 ! columns of mato
              DIM_2 = DB3__MUL_MM_SI_I
              IF ( IND_2 + DIM_2-1 .GT. N3 ) DIM_2 = N3 - IND_2 + 1
!
              IND_1 = 1
              DO 450 J5=1,IP1  ! raws of mato
                 DIM_1 = DB3__MUL_MM_SI_I
...
!$OMP&                     MAT1, MAT2, MAT1C, MAT2C, MAT3C, MATO )
                 DO 460 J6=1,IP1
                    ...
                    IND_M = 1 + (J6-1)*DB3__MUL_MM_SI_I
                    IF ( IND_M + DB3__MUL_MM_SI_I-1 .GT. M1 ) THEN
                         DIM_M = M1 - IND_M + 1
                       ELSE 
                         DIM_M = DB3__MUL_MM_SI_I
                    END IF
!
...
!$OMP END CRITICAL (MATO_UPDATE)
 460             CONTINUE 
!$OMP END PARALLEL DO
                 IND_1 = IND_1 + DB3__MUL_MM_SI_I
 450          CONTINUE 
              IND_2 = IND_2 + DB3__MUL_MM_SI_I
 440       CONTINUE 
!
