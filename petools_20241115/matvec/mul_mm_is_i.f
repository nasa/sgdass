#ifdef GEN_PREFIX
#define FUNC_MUL_MM_IS_I  GEN_MUL_MM_IS_I
#else
#define FUNC_MUL_MM_IS_I  OPT_MUL_MM_IS_I
#endif
#include <mk5_preprocessor_directives.inc>
      SUBROUTINE FUNC_MUL_MM_IS_I ( M1, N1, MAT1, M2, MAT2, M3, N3, MATO, &
     &                              IUER )
! ************************************************************************
! *                                                                      *
! *   Subroutine  MUL_MM_IS_I  multiplies matrixes:                      *
! *   MATO = MAT1 * MAT2                                                 *
! *                                                                      *
! *   MAT1 -- rectangular matrix;                                        *
! *   MAT2 -- symmetric matrix in the upper triangular representation;   *
! *   MATO -- rectangular matrix.                                        *
! *                                                                      *
! *  ###  11-Dec-96    MUL_MM_IS_I   v5.1 (c) L. Petrov 29-DEC-2021 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'matvec.i' ! Definnition of DB1__MUL_MM_IS_I, DB2__MUL_MM_IS_I
...
#ifdef GEN_PREFIX
!
! === Generic version. It is slow and used only for testing
!
      DO 410 J1=1,M3
         DO 420 J2=1,N3
            S=0.D0
...
!
      IF ( M2 .EQ. 2 ) THEN
           DO 510 J1=1,M3
              MATO(J1,1) = MAT1(J1,1)*MAT2(1) + MAT1(J1,2)*MAT2(2) 
              MATO(J1,2) = MAT1(J1,1)*MAT2(2) + MAT1(J1,2)*MAT2(3) 
 510       CONTINUE 
           CALL ERR_LOG ( 0, IUER )
           RETURN
     ...
     &                     MAT1(J1,3)*MAT2(4) 
              MATO(J1,2) = MAT1(J1,1)*MAT2(2) + MAT1(J1,2)*MAT2(3) + &
     &                     MAT1(J1,3)*MAT2(5) 
              MATO(J1,3) = MAT1(J1,1)*MAT2(4) + MAT1(J1,2)*MAT2(5) + &
     &                     MAT1(J1,3)*MAT2(6) 
 520       CONTINUE 
           CALL ERR_LOG ( 0, IUER )
           RETURN
        ELSE IF ( M2 .EQ. 4 ) THEN
           DO 530 J1=1,M3
              MATO(J1,1) = MAT1(J1,1)*MAT2(1) + MAT1(J1,2)*MAT2(2) + &
     &                     MAT1(J1,3)*MAT2(4) + MAT1(J1,4)*MAT2(7) 
              MATO(J1,2) = MAT1(J1,1)*MAT2(2) + MAT1(J1,2)*MAT2(3) + &
     &                     MAT1(J1,3)*MAT2(5) + MAT1(J1,4)*MAT2(8) 
              MATO(J1,3) = MAT1(J1,1)*MAT2(4) + MAT1(J1,2)*MAT2(5) + &
     &                     MAT1(J1,3)*MAT2(6) + MAT1(J1,4)*MAT2(9) 
              MATO(J1,4) = MAT1(J1,1)*MAT2(7) + MAT1(J1,2)*MAT2(8) + &
     &                     MAT1(J1,3)*MAT2(9) + MAT1(J1,4)*MAT2(10) 
 530       CONTINUE 
           CALL ERR_LOG ( 0, IUER )
           RETURN
     ...
     &                     MAT1(J1,3)*MAT2(9) + MAT1(J1,4)*MAT2(10) + &
     &                     MAT1(J1,5)*MAT2(14) 
              MATO(J1,5) = MAT1(J1,1)*MAT2(11) + MAT1(J1,2)*MAT2(12) + &
     &                     MAT1(J1,3)*MAT2(13) + MAT1(J1,4)*MAT2(14) + &
     &                     MAT1(J1,5)*MAT2(15) 
 540       CONTINUE 
           CALL ERR_LOG ( 0, IUER )
           RETURN
        ELSE IF ( M2 .EQ. 6 ) THEN
           DO 550 J1=1,M3
              MATO(J1,1) = MAT1(J1,1)*MAT2(1)  + MAT1(J1,2)*MAT2(2)  + &
     &                     MAT1(J1,3)*MAT2(4)  + MAT1(J1,4)*MAT2(7)  + &
     &                     MAT1(J1,5)*MAT2(11) + MAT1(J1,6)*MAT2(16) 
              MATO(J1,2) = MAT1(J1,1)*MAT2(2)  + MAT1(J1,2)*MAT2(3)  + &
     &                     MAT1(J1,3)*MAT2(5)  + MAT1(J1,4)*MAT2(8)  + &
     &                     MAT1(J1,5)*MAT2(12) + MAT1(J1,6)*MAT2(17) 
              MATO(J1,3) = MAT1(J1,1)*MAT2(4)  + MAT1(J1,2)*MAT2(5)  + &
     &                     MAT1(J1,3)*MAT2(6)  + MAT1(J1,4)*MAT2(9)  + &
     &                     MAT1(J1,5)*MAT2(13) + MAT1(J1,6)*MAT2(18) 
              MATO(J1,4) = MAT1(J1,1)*MAT2(7)  + MAT1(J1,2)*MAT2(8)  + &
     &                     MAT1(J1,3)*MAT2(9)  + MAT1(J1,4)*MAT2(10) + &
     &                     MAT1(J1,5)*MAT2(14) + MAT1(J1,6)*MAT2(19) 
              MATO(J1,5) = MAT1(J1,1)*MAT2(11) + MAT1(J1,2)*MAT2(12) + &
     &                     MAT1(J1,3)*MAT2(13) + MAT1(J1,4)*MAT2(14) + &
     &                     MAT1(J1,5)*MAT2(15) + MAT1(J1,6)*MAT2(20) 
              MATO(J1,6) = MAT1(J1,1)*MAT2(16) + MAT1(J1,2)*MAT2(17) + &
     &                     MAT1(J1,3)*MAT2(18) + MAT1(J1,4)*MAT2(19) + &
     &                     MAT1(J1,5)*MAT2(20) + MAT1(J1,6)*MAT2(21) 
 550       CONTINUE 
           CALL ERR_LOG ( 0, IUER )
           RETURN
     ...
     &                     MAT1(J1,5)*MAT2(20) + MAT1(J1,6)*MAT2(21) + &
     &                     MAT1(J1,7)*MAT2(27)
              MATO(J1,7) = MAT1(J1,1)*MAT2(22) + MAT1(J1,2)*MAT2(23) + &
     &                     MAT1(J1,3)*MAT2(24) + MAT1(J1,4)*MAT2(25) + &
     &                     MAT1(J1,5)*MAT2(26) + MAT1(J1,6)*MAT2(27) + &
     &                     MAT1(J1,7)*MAT2(28)
 560       CONTINUE 
           CALL ERR_LOG ( 0, IUER )
           RETURN
        ELSE IF ( M2 .LE. DB1__MUL_MM_IS_I ) THEN
!
! -------- Small dimensions
!
           ALLOCATE ( VECN(N3) )
           ALLOCATE ( VECO(N3) )
           DO 410 J1=1,M3 
              CALL DCOPY ( N3, MAT1(J1,1), M3, VECN, 1 )
              VECO(1) = VECN(1)*MAT2(1)
              K = 2
              DO 420 J2=2,M2
                 S = 0.0D0
                 DO 430 J3=1,J2-1
                    VECO(J3) = VECO(J3) + VECN(J2)*MAT2(K)
                    S = S + VECN(J3)*MAT2(K)
                    K = K+1
 430             CONTINUE
                 VECO(J2) = S + VECN(J2)*MAT2(K)
                 K = K+1
 420          CONTINUE
...
!
           ...
           IF ( IERR .NE. 0 ) THEN
                ...
                CALL ERR_LOG ( 18, IUER, 'MUL_MM_IS_I', 'Failure to '// &
...
!
           CALL DGEMM ( 'N', 'N', M1, M2, M2, 1.D0, MAT1, &
...
!
           IP1 = M3/DB3__MUL_MM_IS_I 
           IF ( IP1*DB3__MUL_MM_IS_I .LT. M3 ) IP1 = IP1 + 1
           IP2 = N3/DB3__MUL_MM_IS_I 
           IF ( IP2*DB3__MUL_MM_IS_I .LT. N3 ) IP2 = IP2 + 1
!
...
!
           ALLOCATE ( MAT1C(DB3__MUL_MM_IS_I,DB3__MUL_MM_IS_I,NTHR), &
     &                MAT2C(DB3__MUL_MM_IS_I,DB3__MUL_MM_IS_I,NTHR), &
     &                MAT3C(DB3__MUL_MM_IS_I,DB3__MUL_MM_IS_I,NTHR), STAT=IERR )
           IF ( IERR .NE. 0 ) THEN
                CALL CLRCH ( STR )
                CALL IINCH ( 8*3*DB3__MUL_MM_IS_I*DB3__MUL_MM_IS_I*NTHR, STR )
                CALL ERR_LOG ( 20, IUER, 'MUL_MM_IS_I', 'Failure to '// &
     &              'allocate '//STR(1:I_LEN(STR))//' bytes of dynamic '// &
     &              'memory' )
                RETURN 
           END IF
...
#ifdef BLAS_NOT_A_NUMBER
           CALL MEMSET ( MAT1C, 0, %VAL(8*DB3__MUL_MM_IS_I*DB3__MUL_MM_IS_I*NTHR) )
           CALL MEMSET ( MAT2C, 0, %VAL(8*DB3__MUL_MM_IS_I*DB3__MUL_MM_IS_I*NTHR) )
           CALL MEMSET ( MAT3C, 0, %VAL(8*DB3__MUL_MM_IS_I*DB3__MUL_MM_IS_I*NTHR) )
#endif
!
           IND_2 = 1
           DO 440 J4=1,IP2 ! columns of mato
              DIM_2 = DB3__MUL_MM_IS_I
              IF ( IND_2 + DIM_2-1 .GT. N3 ) DIM_2 = N3 - IND_2 + 1
!
              IND_1 = 1
              DO 450 J5=1,IP1  ! raws of mato
                 DIM_1 = DB3__MUL_MM_IS_I
...
!$OMP&                     MAT1, MAT2, MAT1C, MAT2C, MAT3C, MATO )
                 DO 460 J6=1,IP2
                    ...
                    IND_M = 1 + (J6-1)*DB3__MUL_MM_IS_I
                    IF ( IND_M + DB3__MUL_MM_IS_I-1 .GT. M2 ) THEN
                         DIM_M = M2 - IND_M + 1
                       ELSE 
                         DIM_M = DB3__MUL_MM_IS_I
                    END IF
!
...
!$OMP END CRITICAL (MATO_UPDATE)
 460             CONTINUE 
!$OMP END PARALLEL DO
                 IND_1 = IND_1 + DB3__MUL_MM_IS_I
 450          CONTINUE 
              IND_2 = IND_2 + DB3__MUL_MM_IS_I
 440       CONTINUE 
!
