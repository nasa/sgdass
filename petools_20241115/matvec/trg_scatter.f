#include <mk5_preprocessor_directives.inc>
      SUBROUTINE TRG_SCATTER ( M1, IND1, DIM1, IND2, DIM2, AC, A )
! ************************************************************************
! *                                                                      *
! *   Routine  TRG_SCATTER  scatters elements of the rectangular region  *
! *   of the rectangular matrix into the region of the symmetric matrix  *
! *   in upper triangular prepresentation.                               *
! *                                                                      *
! *   A A A A A A A A                                                    *
! *                                                                      *
! *     A A A A A A A                                                    *
...
! *                                                                      *
! *  ### 12-OCT-2002  TRG_SCATTER  v1.1 (c)  L. Petrov  27-JUN-2021 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      ...
      IF ( IND1 .LT. IND2 ) THEN
           ...
           DO 410 J1=1,DIM2
              CALL DCOPY ( DIM1, AC(1,J1), 1, A(LC), 1 )
              LC = LC + (J1-1) + IND2
 410       CONTINUE 
         ELSE IF ( IND1 .EQ. IND2 ) THEN
           LC = INT8(IND2)*INT8(IND2+1)/2 
           DO 420 J2=1,DIM2
              CALL DCOPY ( MIN(J2,DIM1), AC(1,J2), 1, A(LC), 1 )
              LC = LC + IND2 + J2-1
 420       CONTINUE
         ELSE ! ind1 .gt. ind2
           ...
           DO 430 J3=1,DIM1
              NP = IND2-1+J3-IND1
              IF ( NP .GE. 1 ) THEN
                   CALL DCOPY ( MIN(NP,DIM1), AC(J3,1), DIM1, A(LC), 1  )
              END IF
              LC = LC + (J3-1) + IND1
 430       CONTINUE 
      END IF
      RETURN
      END  SUBROUTINE  TRG_SCATTER  !#!#
!
! ------------------------------------------------------------------------
!
      SUBROUTINE TRG_SCATTER_UPD ( M1, IND1, DIM1, IND2, DIM2, AC, A )
! ************************************************************************
! *                                                                      *
! *   Routine  TRG_SCATTER_UPD  scatters elements of the rectangular     *
! *   region of the rectangular matrix into the region of the            *
! *   the symmetric matrix in upper triangular prepresentation and       *
! *   update their values.                                               *
! *                                                                      *
! *   A A A A A A A A                                                    *
! *                                                                      *
...
! *                       A(IND1+DIM1-1,IND2) A(IND1+DIM1-1,IND2+DIM2-1) *
! *                                                                      *
! *  ### 02-AUG-2012 TRG_SCATTER_UPD v1.1 (c) L. Petrov 27-JUN-2021 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  M1, IND1, DIM1, IND2, DIM2
