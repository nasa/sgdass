#include <mk5_preprocessor_directives.inc>
      SUBROUTINE EMVS_15 ( A, EMVS, IUER )
! ************************************************************************
! *                                                                      *
...
!
          ...
          IF ( DLOG10(DABS(EM_L)+1.D-32) - DLOG10(DABS(EM)+1.D-32) .GT. LEP ) THEN
              CALL ERR_LOG ( 1241, IUER, 'EMVS_15', 'Error in an attempt '//   &
...
!
      ...
      IF ( DABS(ER) .GE. EPS ) THEN
           ...
           CALL CLRCH ( STR )
           CALL INCH  ( MAXIT, STR )
          CALL ERR_LOG ( 1242, IUER, 'EMVS_15', 'Error in an attempt '//   &
