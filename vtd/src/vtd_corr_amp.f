      FUNCTION   VTD_CORR_AMP ( BX, BY, PHASE_CENTER_OFFS, FREQ, MAP, IUER )
! ************************************************************************
! *                                                                      *
...
! * PHASE_CENTER_OFFS ( REAL*8 ) -- Offset of the phase center with      *
! *                                 respect to pixel (1,1) in radians.   *
...
! *                                                                      *
! * ### 19-MAR-2007   VTD_CORR_AMP   v1.0 (d) L. Petrov  19-MAR-2007 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'astro_constants.i'
      INCLUDE   'sou_map.i'
      REAL*8     BX, BY, PHASE_CENTER_OFFS(2), FREQ
...
!
      DO 410 J1=1,MAP%NUM_CC
         BP = ( BX*(MAP%COOR_CC(1,J1) - PHASE_CENTER_OFFS(1)) + &
     &          BY*(MAP%COOR_CC(2,J1) - PHASE_CENTER_OFFS(2))   )
         GS = 1.0D0
