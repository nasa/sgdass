      FUNCTION   VTD_GR_DEL_STRUC ( BX, BY, PHASE_CENTER_OFFS, FREQ, MAP, IUER )
! ************************************************************************
! *                                                                      *
...
! *                                                                      *
! *  ### 19-MAR-2007 VTD_GR_DEL_STRUC v1.2 (d) L. Petrov 07-MAR-2026 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
      ...
      DO 420 J2=1,MAP%NUM_CC
         ...
         BP = ( BX*(MAP%COOR_CC(1,J2) - PHASE_CENTER_OFFS(1)) + &
     &          BY*(MAP%COOR_CC(2,J2) - PHASE_CENTER_OFFS(2))   )
