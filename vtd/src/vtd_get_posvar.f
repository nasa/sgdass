...
! *                                                                      *
! * ### 17-DEC-2002  VTD_GET_POSVAR v2.0 (d) L. Petrov  24-JUN-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
         ...
         ELSE 
!
! -------- Compute TIM_MOM -- moment of time of observations in seconds 
...
!
     ...
     &               ( VTD%MOM%TAI - 43200.0D0 )
           TIM_PSV = TIM_MOM - VTD%STA(I_STA)%PSV_TAI_BEG(I_PSV)
     ...
     &                ( VTD%STA(I_STA)%PSV_TIM(NN,I_PSV), NN=1,VTD__M_SDI )
                WRITE ( 6, * ) 'Position variation directory: ', VTD%CONF%POSVAR_FIL(I_PSV)
