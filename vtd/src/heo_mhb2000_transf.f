      SUBROUTINE HEO_MHB2000_TRANSF ( IPAR, TARG_TDB, UT1_M_TDB, E1, E2, &
     &                                DPSI, DEPS, E1_RATE, E2_RATE, &
     &                                DPSI_RATE, DEPS_RATE )
! ************************************************************************
! *                                                                      *
! *   Routine  HEO_MHB2000_TRANSF  computes angles of a small rotation   *
! *   of the coordinate transformation from a celestial coordinate       *
! *   system to the terrestrial coordinate system: E1, E2, as well as    *
! *   nutation angles DPSI, DEPS according to the REN2000 nutation       *
! *   expansion with the transfer function of MHB2000 applied. This      *
! *   nutation expansion contains only forced nutations. It does not     *
! *   contains correction to precession rate, obliquity rate, free core  *
! *   nutation and geodesic nutation. Then the transfer function as      *
! *   presented in the MHB2000  paper togeater with a bunch of           *
! *   corrections to the resonance formula.                              *
...
! *                             Unit: rad.                               *
! *                                                                      *
! * ## 06-OCT-2003 HEO_MHB2000_TRANSF  v3.1 (c) L. Petrov 05-SEP-2006 ## *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'nut_const.i'
      ...
      INTEGER*4  IPAR
      REAL*8     UT1_M_TDB, TARG_TDB, E1, E2, DPSI, DEPS, &
     &           E1_RATE, E2_RATE, DPSI_RATE, DEPS_RATE, CROSS_NUT_E3
      REAL*8     AMP_LIM, AMP_LIM_SQ, AMP_TERM_SQ, SIN_EPS_0, EARTH_PHS, &
     &           ARG, VEL
...
!
      RETURN
      END  SUBROUTINE  HEO_MHB2000_TRANSF  !#!#
