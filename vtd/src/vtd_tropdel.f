...
! *                                                                      *
! *  ### 29-JAN-2004   VTD_TROPDEL  v6.1 (d)  L. Petrov 07-JAN-2015 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
!
              IF ( INDS(3) < 1  .OR.  INDS(3) .GE. DIMS(3) ) THEN
                   WRITE ( 6, * ) 'TIM_BEG= ', VTD%SPD_3D(ISTA)%TIM_BEG
                   WRITE ( 6, * ) 'ARGS(3)= ', ARGS(3)
                   WRITE ( 6, * ) 'TIM_ARR= ', VTD%SPD_3D(ISTA)%TIM_ARR(1:DIMS(3))
                   CALL ERR_LOG ( 2444, IUER, 'VTD_TROPDEL', 'Tr ap of '// &
