...
! *                              in the zenith direction. Units: TECU.   *
...
! *                                                                      *
! * ### 14-MAY-2010  VTD_IONO_DELAY  v2.5 (d) L. Petrov  18-NOV-2025 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
!
      IF ( LAT_GCN_PP > VTD%IONO%HEADER%LAT_MIN + (VTD%IONO%HEADER%NLAT-1)*VTD%IONO%HEADER%LAT_STEP - EPS ) THEN
           LAT_GCN_PP = VTD%IONO%HEADER%LAT_MIN + (VTD%IONO%HEADER%NLAT-1)*VTD%IONO%HEADER%LAT_STEP - EPS
      END IF
      ARGS(2) = LAT_GCN_PP
...
!
! --- Here we compute UTCMTAI -- UTC minus TAI
!
