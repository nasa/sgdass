     ...
     &                        TAU_DER_PRLX, RATE_DER_EOP, RATE_DER_STA1, &
     &                        RATE_DER_STA2, RATE_DER_RA, RATE_DER_DL, IUER )
! ************************************************************************
! *                                                                      *
...
! * TAU_DER_PRLX  ( REAL*8   ) -- Partial derivative of group delay over *
! *                               the annual parallax. Units for         *
! *                               parallax: rad.                         *
...
! *                                                                      *
! *  ### 29-JAN-2004   VTD_PK2001  v6.6 (d)  L. Petrov  31-MAR-2026 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'vtd.i'
     ...
     &           RATE_DER_RA, RATE_DER_DL, TAU_DER_GAMMA, TAU_DER_PRLX
      TYPE     ( VTD__TYPE ) :: VTD
      INTEGER*4  J1, J2, IER
...
!
     ...
     &                                  )/ VTD__C**2                             &
     &                 + TAU_GRAV/2.0D0
      TAU_DER_PRLX = 1.0D0/DIST_SUN_EARTH/VTD__C*                    &
     &               DP_VV_V ( 3, VTD%MOM%PLAN(1,VTD__COO,VTD__EART), B_CRS )/  &
     &                        (1.0D0 + (   DP_VV_V ( 3, VTD%MOM%PLAN(1,VTD__VEL,VTD__EART), &
     &                                                  VTD%SOU(ISOU)%S_CRS               ) &
     &                                + DP_VV_V ( 3, VTD%STA(ISTA2)%VEL_CRS,                &
