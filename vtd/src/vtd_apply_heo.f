      SUBROUTINE VTD_APPLY_HEO ( T_SEC, HEO_EPOCH_SEC, L_HEO, HEO, &
     &                           HEO_VEC, HEO_VEC_DER1, HEO_VEC_DER2, IUER )
! ************************************************************************
! *                                                                      *
! *   Routine  VTD_APPLY_HEO  computes the vector of perturbing rotation *
! *   due to Harmonic Earth Orientation variations using the model       *
! *   presented as an expansion over quasi-harmonic series.              *
! *                                                                      *
! * _________________________ Input parameters: ________________________ *
! *                                                                      *
! *          T_SEC ( REAL*8    ) -- TAI time in seconds elapsed since    *
...
! *                                   case of error.                     *
! *                                                                      *
! * ### 01-OCT-2003  VTD_APPLY_HEO  v2.1 (c)  L. Petrov 11-MAR-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'heo.i'
      REAL*8     T_SEC, HEO_EPOCH_SEC, HEO_VEC(3), &
...
!
     ...
     &         HEO(J1)%PHAS 
         VEL = HEO(J1)%ACCL*T_SEC + HEO(J1)%FREQ
!
         DCOS_ARG = DCOS(ARG)
         DSIN_ARG = DSIN(ARG)
!
