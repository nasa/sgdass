      SUBROUTINE HEO_IERS1996 ( IPAR, TARG_TDB, UT1_M_TDB, E1, E2, DPSI, DEPS, &
     &                          E1_RATE, E2_RATE, DPSI_RATE, DEPS_RATE, &
     &                          CROSS_NUT_E3  )
! ************************************************************************
! *                                                                      *
! *   Routine  HEO_IERS1996  computes angles of small rotation of the    *
! *   coordinate transformation from a celestial coordinate system to    *
! *   the terrestrial coordinate system: E1, E2, or nutation angles      *
! *   DPSI, DEPS according to the IERS96 nutation expansion.             *
! *   This routine computes rate of change of E1,E2 or DEPS,DPSI         *
! *   as well.                                                           *
! *                                                                      *
! *   Reference:                                                         *
! *   McCarthy, ed., IERS Conventions 1996, IERS Technical Note 21,      *
...
! *                             Unit: rad.                               *
! *                                                                      *
! *  ###  06-OCT-2003  HEO_IERS1996  v3.1 (c) L. Petrov 05-SEP-2006 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'nut_const.i'
     ...
     &           ARG, VEL
      ...
      REAL*8     OM_CORR, PHS_CORR
!
      REAL*8     PRC_IN, PRC_IN_RATE, PRC_OUT, PRC_OUT_RATE
      INTEGER*4  J1
!
! --- Compute some constants: sin(epsilon_o) and square of minimal amplitude
!
...
!
           PRC_IN       = EPS_OFFS_IERS96*MAS_TO_RAD
           PRC_IN_RATE  = EPS_RATE_IERS96/(86400.0D0*365.25D0)*MAS_TO_RAD
           PRC_OUT      = PSI_OFFS_IERS96*SIN_EPS_0*MAS_TO_RAD
           PRC_OUT_RATE = PSI_RATE_IERS96*SIN_EPS_0/(86400.0D0*365.25D0)* &
     &                    MAS_TO_RAD
           E1 = E1*1.D-12   &
...
!
     ...
     &            EPS_OFFS_IERS96 ) * MAS_TO_RAD
           DPSI = DPSI*1.D-12/SIN_EPS_0  + &
     &          ( TARG_TDB*PSI_RATE_IERS96/(86400.0D0*365.25D0) + &
     &            PSI_OFFS_IERS96 ) * MAS_TO_RAD
!
           DEPS_RATE = DEPS_RATE*1.D-12 + &
     &          EPS_RATE_IERS96/(86400.0D0*365.25D0)*MAS_TO_RAD
           DPSI_RATE = DPSI_RATE*1.D-12/SIN_EPS_0  + &
     &          PSI_RATE_IERS96/(86400.0D0*365.25D0)*MAS_TO_RAD
