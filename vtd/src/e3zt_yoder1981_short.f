      SUBROUTINE E3ZT_YODER1981_SHORT ( MJD, TAI_SEC, E3, E3_DOT ) 
! ************************************************************************
! *                                                                      *
! *   Routine E3ZT_YODER1981_SHORT  computes contribution of zonal solid *
! *   Earth tides to the Euler angle around the axis 3 as well as its    *
! *   time derivative. Expansion of Yoder 1981 is used. Only 41 terms    *
! *   with periods shorter than 41 days are taken into account.          *
...
! *                          Units: rad/sec.                             *
! *                                                                      *
! * ## 22-MAR-2004 E3ZT_YODER1981_SHORT v1.0 (c) L. Petrov 22-MAR-2004 # *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      ...
      INTEGER*4    N_YODER19891_SHORT
      PARAMETER  ( N_YODER19891_SHORT = 41 )
      INTEGER*4  J1
!
     ...
     &          32.184D0
      E3     = 0.0D0
      E3_DOT = 0.0D0
      DO 410 J1=1,N_YODER19891_SHORT 
...
!
      RETURN
      END  SUBROUTINE E3ZT_YODER1981_SHORT
