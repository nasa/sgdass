...
! *                                                                      *
! * ###  23-JUN-1992  VTD_ROTMAT    v2.0 (d) L. Petrov 08-DEC-2003  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IAX
...
!
        ...
        ELSE
           WRITE ( 6, * ) ' IAX = ', IAX
           CALL ERR_LOG ( 123, -1, 'VTD_ROTMAT', 'Error of internal '// &
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 23-JUN-1992  VTD_ROTMAT_DER  v2.0 (d) L. Petrov 08-DEC-2003  ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IAX
...
!
        ...
        ELSE
           WRITE ( 6, * ) ' IAX = ', IAX
           CALL ERR_LOG ( 124, -1, 'VTD_ROTMAT_DER', 'Error of internal '// &
     &         'control: wrong parameter IAX' )
           CALL EXIT ( 1 )
      END IF
!
...
! ------------------------------------------------------------------------
!
      SUBROUTINE VTD_ROTMAT_DER2 ( IAX, ANGLE, ANGLE_RATE, ANGLE_ACCL, MAT )
! ************************************************************************
! *                                                                      *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 23-JUN-1992  VTD_ROTMAT_DER2 v2.0 (d) L. Petrov 08-JUN-2004  ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IAX
...
!
        ...
        ELSE
           WRITE ( 6, * ) ' IAX = ', IAX
           CALL ERR_LOG ( 125, -1, 'VTD_ROTMAT_DER2', 'Error of internal '// &
     &         'control: wrong parameter IAX' )
           CALL EXIT ( 1 )
      END IF
!
