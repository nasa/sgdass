class vsdc_config_class:
   def __init__ ( self, filename ):
       ...
       self.uplolad_manifest   = None
       self.uplolad_command    = None
...
vsdc__config_label_v104 = "# VSDC_CONFIG file. Version 1.04 of 2021.05.10"
vsdc__config_label      = "# VSDC_CONFIG file. Version 1.05 of 2026.07.22"
vsdc__nscodes_label     = "* ns-codes.txt 010717 format"
vsdc_swin_gentar__label = "vsdc_swin  1.18 of 2023.01.03"
vsdc_manitset__label    = "vsdc_manifest version 0.98 of 2026.07.22"
vsdc__config_pars       = 20
vsdc__ddf_pars          = 14
vsdc__num_mf            = 16
