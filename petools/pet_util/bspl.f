...
! *                        be no less than 0.                            *
! *  KNOT ( INTEGER*4 ) -- The leading (or pivotal) knot of the spline.  *
! *                        The spline is zero at  [-inf, ARR(KNOT)) and  *
! *                                 [ARR(KNOT+IDEG+1), +inf].            *
! *                        Since the first (and the last) knot of the    *
! *                        sequence are multiple, splines with leading   *
! *                        knots 1-IDEG, ..., -2, -1, 0  are defined.    *
...
! *                                                                      *
! *  ### 01-MAY-2003   BSPL_VAL    v1.0 (d)  L. Petrov  01-MAY-2003 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 01-MAY-2003   BSPL_DER    v1.0 (d)  L. Petrov  01-MAY-2003 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 18-JAN-2004   BSPL_DR2    v1.0 (d)  L. Petrov  18-JAN-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 01-MAY-2003   BSPL_DR3    v1.0 (d)  L. Petrov  18-JAN-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 01-MAY-2003   BSPL_INT    v1.2 (d)  L. Petrov  08-JUN-2025 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
...
! ------------------------------------------------------------------------
!
      FUNCTION   BSPL_INT2 ( MAR, ARR, IDEG, KNOT, ARG )
! ************************************************************************
! *                                                                      *
! *   Function  BSPL_INT2  computes the double integral of the           *
! *   normalized B-spline of the IDEG degree defined at the sequence of  *
! *   knots KNOT, KNOT+1, ... KNOT+IDEG+1 of the array ARR in the limits *
! *   from minus infinity to ARG. Normalization is chosen in such        *
! *   a way that for any given sequence of N knots ( N > IDEG ) and any  *
! *   given X                                                            *
! *                                                                      *
...
! * _________________________ Output parameters: _______________________ *
! *                                                                      *
! * <BSPL_INT2> ( REAL*8   ) -- Double Integral of the B-spline in the   *
! *                             limits from minus infinity to ARG.       *
! *                                                                      *
! *   Copyright (c) 1975-2025 United States Government as represented by *
! *   the Administrator of the National Aeronautics and Space            *
! *   Administration. All Rights Reserved.                               *
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 01-MAY-2003   BSPL_INT2    v1.2 (d)  L. Petrov  08-JUN-2025 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
      REAL*8     BSPL_INT2, ARR(MAR), ARG
      INTEGER*4  IND_L, IND_R, IND_LL, IND_RR, J1, J2
      REAL*8     R
      REAL*8,    EXTERNAL :: BSPL_VAL, BSPL_INT
!
      BSPL_INT2 = 0.0
      IF ( IDEG .LE. 1 ) RETURN
!
...
!
      ...
      DO 410 J1=KNOT,MAR-1
         BSPL_INT2 = BSPL_INT2 + BSPL_INT ( MAR, ARR, IDEG+1, J1, ARG )
410   CONTINUE 
!
      IND_R = KNOT + IDEG + 1
      IF ( IND_R .GT. MAR ) IND_R = MAR
      IF ( IND_R .LT.   1 ) IND_R = 1
      BSPL_INT2 = BSPL_INT2 * ( ARR(IND_R) - ARR(IND_L) )/( IDEG + 1 )
!
      RETURN
      END  FUNCTION   BSPL_INT2  !#!#
!
! ------------------------------------------------------------------------
!
      FUNCTION   BSPL_INT3 ( MAR, ARR, IDEG, KNOT, ARG )
! ************************************************************************
! *                                                                      *
! *   Function  BSPL_INT3  computes the tripple integral of the          *
! *   normalized B-spline of the IDEG degree defined at the sequence of  *
! *   knots KNOT, KNOT+1, ... KNOT+IDEG+1 of the array ARR in the limits *
! *   from minus infinity to ARG. Normalization is chosen in such        *
! *   a way that for any given sequence of N knots ( N > IDEG ) and any  *
...
! * _________________________ Output parameters: _______________________ *
! *                                                                      *
! * <BSPL_INT3> ( REAL*8   ) -- Tripple Integral of the B-spline in the  *
! *                             limits from minus infinity to ARG.       *
! *                                                                      *
! *   Copyright (c) 1975-2025 United States Government as represented by *
! *   the Administrator of the National Aeronautics and Space            *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 01-MAY-2003   BSPL_INT3    v1.2 (d)  L. Petrov  08-JUN-2025 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
      REAL*8     BSPL_INT3, ARR(MAR), ARG
      INTEGER*4  IND_L, IND_R, IND_LL, IND_RR, J1, J2
      REAL*8     R
      REAL*8,    EXTERNAL :: BSPL_VAL, BSPL_INT2
!
      BSPL_INT3 = 0.0
      IF ( IDEG .LE. 1 ) RETURN
!
...
!
      BSPL_INT3 = 0.0D0
      DO 410 J1=KNOT,MAR-1
         BSPL_INT3 = BSPL_INT3 + BSPL_INT2 ( MAR, ARR, IDEG+1, J1, ARG )
410   CONTINUE 
!
      BSPL_INT3 = BSPL_INT3 * ( ARR(IND_R) - ARR(IND_L) )/( IDEG + 1 )
!
      RETURN
      END  FUNCTION   BSPL_INT3  !#!#
!
! ------------------------------------------------------------------------
!
      FUNCTION   BSPL_MOM1 ( MAR, ARR, IDEG, KNOT, ARG )
! ************************************************************************
! *                                                                      *
! *   Function  BSPL_MOM1  computes the first moment of the normalized   *
! *   B-spline of the IDEG degree defined at the sequence of knots       *
! *   KNOT, KNOT+1, ... KNOT+IDEG+1 of the array ARR in the limits       *
! *   from minus infinity to ARG. Normalization is chosen in such        *
! *   a way that for any given sequence of N knots ( N > IDEG ) and any  *
...
! * _________________________ Output parameters: _______________________ *
! *                                                                      *
! * <BSPL_MOM1> ( REAL*8    ) -- Integral of the B-spline in the limits   *
! *                             from minus infinity to ARG.              *
! *                                                                      *
! *   Copyright (c) 1975-2025 United States Government as represented by *
! *   the Administrator of the National Aeronautics and Space            *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 01-MAY-2003   BSPL_MOM1    v1.2 (d)  L. Petrov  08-JUN-2025 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
      REAL*8     BSPL_MOM1, ARR(MAR), ARG
      INTEGER*4  IND_R, IND_L
      REAL*8,    EXTERNAL :: BSPL_MOM1_FULL, BSPL_INT, BSPL_INT2
!
      BSPL_MOM1 = 0.0
      IF ( IDEG .LT. 0 ) RETURN
!
...
!
      IF ( ARG .LE. ARR(IND_L) ) THEN
           BSPL_MOM1 = 0.0D0
         ELSE
           BSPL_MOM1 = ARG*BSPL_INT  ( MAR, ARR, IDEG, KNOT, ARG ) - &
     &                     BSPL_INT2 ( MAR, ARR, IDEG, KNOT, ARG )
      END IF
!
      RETURN
      END  FUNCTION  BSPL_MOM1  !#!#
!
! ------------------------------------------------------------------------
!
      FUNCTION   BSPL_MOM2 ( MAR, ARR, IDEG, KNOT, ARG )
! ************************************************************************
! *                                                                      *
! *   Function  BSPL_MOM2  computes the second moment of the normalized  *
! *   B-spline of the IDEG degree defined at the sequence of knots       *
! *   KNOT, KNOT+1, ... KNOT+IDEG+1 of the array ARR in the limits       *
! *   from minus infinity to ARG. Normalization is chosen in such        *
! *   a way that for any given sequence of N knots ( N > IDEG ) and any  *
...
! * _________________________ Output parameters: _______________________ *
! *                                                                      *
! * <BSPL_MOM2> ( REAL*8    ) -- Integral of the B-spline in the limits   *
! *                             from minus infinity to ARG.              *
! *                                                                      *
! *   Copyright (c) 1975-2025 United States Government as represented by *
! *   the Administrator of the National Aeronautics and Space            *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 01-MAY-2003   BSPL_MOM2    v1.2 (d)  L. Petrov  08-JUN-2025 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
      REAL*8     BSPL_MOM2, ARR(MAR), ARG
      REAL*8     I1, I2, I3
      INTEGER*4  IND_R, IND_L
      REAL*8,    EXTERNAL :: BSPL_INT, BSPL_INT2, BSPL_INT3
!
      BSPL_MOM2 = 0.0
      IF ( IDEG .LT. 0 ) RETURN
!
...
!
      IF ( ARG .LE. ARR(IND_L) ) THEN
           BSPL_MOM2 = 0.0D0
         ELSE
           I1 = BSPL_INT  ( MAR, ARR, IDEG, KNOT, ARG )
           I2 = BSPL_INT2 ( MAR, ARR, IDEG, KNOT, ARG )
           I3 = BSPL_INT3 ( MAR, ARR, IDEG, KNOT, ARG )
           BSPL_MOM2 = (I1*ARG - 2*I2)*ARG + 2.0D0*I3
      END IF
!
      RETURN
      END  FUNCTION  BSPL_MOM2  !#!#
!
! ------------------------------------------------------------------------
!
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 18-OCT-2013   BSPL_JNT    v1.1 (d)  L. Petrov  18-OCT-2013 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  IDEG, MAR, KNOT
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 16-JAN-2014   BSPL_KNT    v1.2 (d)  L. Petrov  23-APR-2014 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 13-MAY-2003    BSPL_FOUR   v1.2 (d) L. Petrov  08-MAR-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 13-MAY-2003    SPL_INT    v1.1 (d)  L. Petrov  08-MAR-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      REAL*8     SPL_INT
...
! ------------------------------------------------------------------------
!
      SUBROUTINE MULTI_SPL_INT ( MAR, ARR, MDEG, COEF, M, XUP_ARR, INT_ARR )
! ************************************************************************
! *                                                                      *
! *   Routine MULTI_SPL_INT computes a series of intergals of a given    *
! *   function in a range from ARR(1) as the lower integration limit to  *
! *   XUP_ARR as the upper integration limit. XUP_ARR is an array of M   *
! *   elements. Result of integration is written into array INT_ARR of   *
! *   M elements. The function inder integration is expanded into an     *
! *   B-spline basis over the array knots ARR.                           *
! *                                                                      *
! *   The spline is defined as                                           *
! *                                                                      *
! *     S(x) = sum_{k=1-ideg}^(k=mar-1) coef(k+ideg) bspl^ideg_k(x)      *
...
! *   K, K+1, ... K+IDEG+1.                                              *
! *                                                                      *
! *   Array of coefficients has dimension (1-MDEG:MAR-1).                *
! *                                                                      *
! * _________________________ Input parameters: ________________________ *
! *                                                                      *
! *  MARR ( INTEGER*4   ) -- The total number of points in the array     *
! *                          ARR.                                        *         
! *   ARR ( REAL*8      ) -- Array of knots at which the spline is       *
! *                          defined. Dimension: MAR.                    *
! *  MDEG ( INTEGER*4   ) -- The degree of the spline. The degree        *
! *                          should be no less than 0.                   *
! *  COEF ( REAL*8      ) -- Array of coefficents of expamsion of the    *
! *                          spline on the basis of B-splines.           *
! *                          Dimension: (1-MDEG:MAR-1).                  *
! * XUP_ARR ( REAL*8    ) -- Array of upper limits of integration.       *
! *                          If X_UP(k) < ARR(1). Dimension: M.          *
! *                                                                      *
! * _________________________ Output parameters: _______________________ *
! *                                                                      *
! * INT_ARR ( REAL*8    ) -- Integral of integrals of the function       *
! *                          in the limits [ARR(1), X_UP(k)].            *
! *                          Dimension: M.                               *
! *                                                                      *
! *   Copyright (c) 1975-2025 United States Government as represented by *
! *   the Administrator of the National Aeronautics and Space            *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 10-FEB-2022 MULTI_SPL_INT  v1.0 (d)  L. Petrov 10-FEB-2022 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      REAL*8     SPL_INT
      INTEGER*4  MAR, M, MDEG
      REAL*8     ARR(MAR), COEF(1-MDEG:MAR-1), XUP_ARR(M), INT_ARR(M)
      REAL*8     R, XUP_VAL, EPS
      PARAMETER  ( EPS = 1.D-8 )
      INTEGER*4  IND_L, IND_R, J1, J2, J3
      REAL*8     BSPL_VAL
!
      INT_ARR = 0.0D0
      DO 410 J1=1-MDEG,MAR-1
         R = 0.0D0
         DO 420 J2=1-MDEG,J1
            IND_L = J2+MDEG+1
            IND_R = J2
            ...
            IF ( IND_R .LT.   1 ) IND_R = 1
            IF ( IND_R .GT. MAR ) IND_R = MAR
            R = R + COEF(J2)* ( ARR(IND_L) - ARR(IND_R) )
 420     CONTINUE
         DO 430 J3=1,M
            XUP_VAL = XUP_ARR(J3)
            IF ( XUP_VAL > ARR(MAR) - EPS*(ARR(MAR) - ARR(MAR-1)) ) THEN
!
! -------------- Make a corretion to avoid a wrong result when XUP_ARR(J3) = FUN(MARR)
!
                 XUP_VAL = ARR(MAR) - EPS*(ARR(MAR) - ARR(MAR-1))
            END IF
            INT_ARR(J3) = INT_ARR(J3) + R*BSPL_VAL( MAR, ARR, MDEG+1, J1, XUP_VAL )
 430     CONTINUE 
 410  CONTINUE
!
      INT_ARR = INT_ARR/(MDEG+1)
      RETURN
      END  SUBROUTINE MULTI_SPL_INT  !#!#
!
! ------------------------------------------------------------------------
!
      FUNCTION   SPL_KINT ( MAR, ARR, IDEG, BSPL, X_DOWN, X_UP )
! ************************************************************************
! *                                                                      *
...
! * _________________________ Output parameters: _______________________ *
! *                                                                      *
! * <SPL_KINT> ( REAL*8 ) -- Integral of the spline in the limits        *
! *                          [X_DOWN, X_UP].                             *
! *                                                                      *
! *   Copyright (c) 1975-2025 United States Government as represented by *
! *   the Administrator of the National Aeronautics and Space            *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 07-AUG-2017   SPL_KINT    v1.0 (d)  L. Petrov  07-AUG-2017 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      REAL*8     SPL_KINT
      INTEGER*4  MAR, IDEG
      REAL*8     ARR(MAR), BSPL(1-IDEG:MAR), X_DOWN, X_UP
...
!
           DO 410 J1=1-IDEG,MAR-1
              ...
              IF ( IND_R .LT.   1 ) IND_R = 1
              IF ( IND_R .GT. MAR ) IND_R = MAR
              SPL_KINT = SPL_KINT + BSPL(J1)* ( ARR(IND_L) - ARR(IND_R) )
 410       CONTINUE
           SPL_KINT = SPL_KINT/(IDEG+1)
         ELSE
!
! -------- The case when the upper limit of integration is within the
! -------- range of the spline
...
!
                   DO 440 J4=J2-IDEG,J2
                      SPL_KINT = SPL_KINT + BSPL(J4)* ( BSPL_INT ( MAR, ARR, IDEG, J4, ARR(J2+1) ) - &
     &                                                  BSPL_INT ( MAR, ARR, IDEG, J4, X_DOWN    )   )
 440               CONTINUE 
...
!
                   DO 450 J5=J2-IDEG,J2
                      SPL_KINT = SPL_KINT + BSPL(J5)* ( BSPL_INT ( MAR, ARR, IDEG, J5, X_UP    ) - &
     &                                                  BSPL_INT ( MAR, ARR, IDEG, J5, ARR(J2) )   )
 450               CONTINUE 
...
!
                   DO 460 J6=J2-IDEG,J2
                      SPL_KINT = SPL_KINT + BSPL(J6)* ( BSPL_INT ( MAR, ARR, IDEG, J6, X_UP    ) - &
     &                                                  BSPL_INT ( MAR, ARR, IDEG, J6, X_DOWN  )   )
 460               CONTINUE 
                ELSE
!
! -----------------   |#########|
!
                   DO 470 J7=J2-IDEG,J2
                      SPL_KINT = SPL_KINT + BSPL(J7)* ( BSPL_INT ( MAR, ARR, IDEG, J7, ARR(J2+1) ) - &
     &                                                  BSPL_INT ( MAR, ARR, IDEG, J7, ARR(J2)   )   )
 470               CONTINUE 
              END IF
 420       CONTINUE
      END IF
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 09-MAY-2003    SPL_FOUR   v1.0 (d)  L. Petrov  09-MAY-2003 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  MAR, IDEG
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 07-MAR-2004  BSPL_MOM1_FULL v1.0 (d)  L. Petrov 08-MAR-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 07-MAR-2004  BSPL_MOM2_FULL  v1.0 (d) L. Petrov 08-MAR-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  MAR, IDEG, KNOT
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 07-MAR-2004  BSPL_INT1_FULL  v2.0 (d) L. Petrov  18-OCT-2013 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  MAR, IDEG, KNOT
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 07-MAR-2004  BSPL_INT2_FULL v1.0 (d) L. Petrov  08-MAR-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  MAR, IDEG, KNOT
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 07-MAR-2004  BSPL_INT3_FULL  v1.0 (d) L. Petrov  08-MAR-2004 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  MAR, IDEG, KNOT
