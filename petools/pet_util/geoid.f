        SUBROUTINE GEOID ( IPAR, R, PHI_GCN, PHI_GDT, LAMBDA, H_ELL, &
     &                     RD, G_ACC )
! ************************************************************************
! *                                                                      *
! *     Routine  GEOID  computes geocentric latitude, geodetic latitude, *
...
! *                          system. Units: m.                           *
! *                                                                      *
! * _______________________ ÷ùèïäîùå ðáòáíåôòù: ________________________ *
! *                                                                      *
...
! *                                                                      *
! *  ###   26-NOV-1993   GEOID   v 3.1  (d) L. Petrov  22-AUG-2002 ###   *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        INTEGER*4  IPAR
