...
! *                                                                      *
! *  ### 04-FEB-2008  BSPL4_4D_CMP  v2.0 (d) L. Petrov  19-APR-2009 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 04-FEB-2008 BSPL4_4D_DIM_CMP v2.1 (d) L. Petrov  29-DEC-2021 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 01-FEB-2008   VAL_4D_BSPL4   v1.0 (d)  L. Petrov 04-FEB-2008 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 01-FEB-2008  VAL_DER_4D_BSPL4 v1.0 (d) L. Petrov 04-FEB-2008 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  DEG, INDS(4), DIMS(4)
...
! ------------------------------------------------------------------------
!
      FUNCTION VAL_4D_BSPLJ4 ( ARGS, DEG, DIMS, INDS, ARG_ARR_1, ARG_ARR_2, &
     &                         ARG_ARR_3, ARG_ARR_4, BCF )
! ************************************************************************
! *                                                                      *
! *   Routine VAL_4D_BSPLJ4  computes the integral over the dimension    *
...
! * ________________________ Output parameters: _______________________  *
! *                                                                      *
! * <VAL_4D_BSPLJ4> ( REAL*4 ) -- Value of the 4D integral over interval *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 22-OCT-2013  VAL_4D_BSPLJ4   v1.0 (d) L. Petrov 22-OCT-2013  ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  DEG, INDS(4), DIMS(4)
     ...
     &           ARG_ARR_3(DIMS(3)), ARG_ARR_4(DIMS(4)), &
     &           BCF(1-DEG:DIMS(1),1-DEG:DIMS(2),1-DEG:DIMS(3),1-DEG:DIMS(4))
      REAL*4     VAL_4D_BSPLJ4 
      INTEGER*4  MDEG
      PARAMETER  ( MDEG = 16 )
      REAL*4     BSPL(-MDEG:0,4), BSPLJ(1-MDEG:DIMS(1))
      INTEGER*4  J1, J2, J3, J4, J5, J6, J7, J8
