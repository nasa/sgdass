...
! *   forms the parallelepipeds. Boundary conditions on the first        *
...
! *                                                                      *
! *  ### 28-FEB-2008   BSPL_3D_CMP  v2.0 (d) L. Petrov  19-APR-2009 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
! *   a 3 dimensional function. This funcion perfofrms update for the    *
! *   dimension DIM. The interpolated function is given at nodes of      *
! *   a regular mesh that forms a parallelepipeds. The following        *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 28-FEB-2008  BSPL_3D_DIM_CMP  v2.2 (d) L. Petrov 29-DEC-2021 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
      ...
      IF ( IER .NE. 0 ) THEN
           CALL CLRCH  ( STR )
           CALL IINCH8 ( INT8(4)*INT8(DEG+1)*INT8(M+DEG-1), STR)
...
!
      ...
      IF ( IER .NE. 0 ) THEN
           CALL CLRCH  ( STR )
           CALL IINCH8 ( INT8(4)*INT8(M1+DEG)*INT8(M2+DEG)*INT8(M3+DEG), STR)
...
!$OMP&     PRIVATE ( J12, J3, J14, IER  ), &
!$OMP&     SHARED  ( M, M1, M2, M3, DEG, IPIV, MAT_B4, BC, BCF ), &
!$OMP&     SCHEDULE ( STATIC )
#endif
!
! -------- The order of dimensions: 1,2,3
...
!$OMP&     PRIVATE ( J15, J6, J17, IER  ), DEFAULT(NONE), &
!$OMP&     SHARED  ( M, M1, M2, M3, DEG, IPIV, MAT_B4, BC, BCF ), &
!$OMP&     SCHEDULE ( STATIC )
#endif
!
...
#else
!$OMP      PARALLEL DO IF ( NTHR > 1 ), &
!$OMP&     PRIVATE ( J18, J19, J20, IER ), DEFAULT(NONE), &
!$OMP&     SHARED  ( M, M1, M2, M3, DEG, IPIV, MAT_B4, BC, BCF ), &
!$OMP&     SCHEDULE ( STATIC )
#endif
!
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ###  28-FEB-2008   VAL_3D_BSPL   v1.0 (d)  L. Petrov 28-FEB-2008 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 01-FEB-2008  VAL_DER_3D_BSPL  v1.0 (d) L. Petrov 04-FEB-2008 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  DEG, INDS(3), DIMS(3)
