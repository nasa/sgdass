...
! *                                                                      *
! *  ### 05-JUL-1995   MAKE_SPLINE  v2.0 (d) L. Petrov 24-DEC-1998  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  05-JUL-1995     FSPL8    v1.1  (d) L. Petrov  10-APR-2006 ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT  NONE
        INTEGER*4 N, IXC
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  06-JUL-1995    DSPL8    v1.1  (d) L. Petrov  10-APR-2006  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT  NONE
        INTEGER*4 N, IXC
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  06-JUL-1995    D2SPL8   v1.2  (d) L. Petrov  10-APR-2006  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT  NONE
        INTEGER*4 N, IXC
...
! ------------------------------------------------------------------------
!
        FUNCTION  D3SPL8 ( XC, N, X, Y, IXC, COEF )
! ************************************************************************
! *                                                                      *
! *     Function  D3SPL8  computes the interploated value of the third   *
! *   derivative of the function Y(X) at the point XC using the          *
! *   coefficients of the cubic spline COEF computed by the program      *
! *   MAKE_SPLINE before the call of D3SPL8.                             *
! *   Argument IXC -- the index of pivot element should be computed      *
! *   before call of DSPL8 using function IXMN8 or IXMN8_S. The pivot    *
! *   element is the minimal element of the fucntino Y(X) which is       *
! *   equal or greater than XC.                                          *
...
! * _______________________ Output parameters: _________________________ *
! *                                                                      *
! * <D3SPL8> ( REAL*8 ) -- Value of the second derivative of the cubic   *
! *                        spline interpolating the the function Y(X)    *
! *                        in the point XC.                              *
! *                                                                      *
! *  Comment: IF XC is out of range [ X(1), X(N) ], then extrapolation   *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  23-FEB-2022   D3SPL8   v1.0  (d) L. Petrov  23-FEB-2022   ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT  NONE
        INTEGER*4 N, IXC
        REAL*8    D3SPL8, XC, X(N), Y(N), COEF(N)
        REAL*8    H, DH, C, D
!
! ----- Check of the number of actual arguments
!
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  10-JUL-1995    ISPL8   v 1.1  (d)  L. Petrov  10-MAR-2008 ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT  NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  25-JUN-2013  ISPL8_UP  v 1.0  (d)  L. Petrov  25-JUN-2013 ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT  NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  20-OCT-1989    FLIN8    v 1.1 (d) L. Petrov  10-APR-2006  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT  NONE
