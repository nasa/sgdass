...
! *                                                                      *
! *  ### 05-JUL-1991     RG_TAT    v1.2 (d)  L. Petrov  27-JUN-2009 ###  *
! *                                                                      *
! ************************************************************************
...
!C
!        PARAMETER ( N_ARG=4 )  !  ëïìéþåóô÷ï æïòíáìøîùè ðáòáíåôòï÷
!C
...
!C
!C
!C ----- ðòï÷òåëá ëïòòåëôîïóôé ÷èïäîùè ðáòáíåôòï÷
!C
!        IF ( .NOT. LW$STR ( GSTR  ) ) THEN
!             CALL ERR_LOG ( 3, IUER, 'RG_TAT', 'îåäïóôõðîá äìñ '//
!     $                               'úáðéóé ÷ùèïäîáñ óôòïëá' )
!             RETURN
!        END IF
!C
!        IF ( .NOT. PROBE_R ( 1, 8, RAD  ) ) THEN
!             CALL ERR_LOG ( 4, IUER, 'RG_TAT', 'îåäïóôõðåî äìñ '//
!     $                               'þôåîéñ ðáòáíåôò RAD' )
!             RETURN
!        END IF
!
