      FUNCTION   VAL_4D_BSPLE3_R4 ( ARGS, DIMS, INDS, ARG_ARR_1, &
     &                              ARG_ARR_2, ARG_ARR_3, ARG_ARR_4, BCF )
! ************************************************************************
! *                                                                      *
! *   Routine VAL_4D_BSPLE3_R4 computes the value of the 4D spline       *
...
! *                                                                      *
! *   NB: VAL_4D_BSPLE3_R4 does not make a check of validity of          *
! *   extended knots. If the step is too big, the result will be wrong.  *
! *   If the step is too short, VAL_4D_BSPLE3_R4 will crash.             *
! *                                                                      *
...
! *                                                                      *
! * <VAL_4D_BSPLE3> ( REAL*4    ) -- Value of the 3D spline at the point *
! *                                  with coordinates                    *
! *                                  (ARG_1, ARG_2, ARG_3, ARG_4 ).      *
! *                                                                      *
...
! *                                                                      *
! * ### 10-NOV-2014 VAL_4D_BSPLE3_R4 v1.1 (d) L. Petrov 10-NOV-2014  ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  INDS(4), DIMS(4)
      REAL*4     VAL_4D_BSPLE3_R4
      INTEGER*4    DEG
      PARAMETER  ( DEG = 3 )
      REAL*4     ARGS(4), &
     ...
     &           BCF(1-DEG:DIMS(1),1-DEG:DIMS(2),1-DEG:DIMS(3),1-DEG:DIMS(4))
      REAL*4     VAL
      REAL*4     BSPL(-DEG:0,4), DSPL(-DEG:0,4)
...
!
 ...
 430  CONTINUE 
      DO 440 J4=-DEG,0
         BSPL(J4,4) = BSPLE3_VAL_R4 ( DIMS(4), ARG_ARR_4, INDS(4)+J4, ARGS(4) )
 440  CONTINUE 
!
...
!
 ...
 460     CONTINUE 
 450  CONTINUE 
      VAL_4D_BSPLE3_R4 = VAL
!
      RETURN
      END  FUNCTION  VAL_4D_BSPLE3_R4  !#!#
!
! ------------------------------------------------------------------------
!
      SUBROUTINE VAL_DER_4D_BSPLE3_R4 ( ARGS, DIMS, INDS, ARG_ARR_1, &
     &                                  ARG_ARR_2, ARG_ARR_3, BCF, &
     &                                  VAL, DER )
! ************************************************************************
! *                                                                      *
! *   Routine VAL_DER_4D_BSPLE3_R4 computes the value of the 4D spline   *
...
! *   at the end is recommended to be eps*(arg[n] - arg[n-1]).           *
! *                                                                      *
! *   NB: VAL_DER_4D_BSPLE3_R4 does not make a check of validity of     *
! *   extended knots. If the step is too big, the result will be wrong.  *
! *   If the step is too short, VAL_DER_4D_BSPLE3_R4 will crash.         *
! *                                                                      *
! *   It is recommended to use routine BSPLE3_EXTEND_R4 for computing    *
! *   extended knots.                                                    *
! *                                                                      *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ## 01-FEB-2008 VAL_DER_4D_BSPLE3_R4 v1.1 (d) L. Petrov 10-NOV-2014 # *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  INDS(4), DIMS(4)
...
!
 ...
 430  CONTINUE 
      DO 440 J4=-DEG,0
         BSPL(J4,4) = BSPLE3_VAL_R4 ( DIMS(4), ARG_ARR_4, INDS(4)+J4, ARGS(4) )
         DSPL(J4,4) = BSPLE3_DER_R4 ( DIMS(4), ARG_ARR_4, INDS(4)+J4, ARGS(4) )
 440  CONTINUE 
!
! --- Compute the tensor product of B-splines
!
...
!
      RETURN
      END  SUBROUTINE  VAL_DER_4D_BSPLE3_R4  !#!#
