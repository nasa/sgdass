...
int itti_chr_del ( putchr, getchr, delchr, putlen, getlen, dellen )
/*
# ************************************************************************
# *                                                                      *
...
# *   line getstr in NOECHO mode whil it reads the symbol DELCHR.        *
# *   The input is terminated when the last symbol is entered.           *
# *   Symbol <Return> is not considered as a terminator.                 *
# *                                                                      *
# *   CALL ITTI_CHR_DEL ( PUTCHR, GETCHR, DELIMITER )                    *
# *                                                                      *
...
# *                                                                      *
# *  ###  24-MAR-2000  ITTI_CHR_DEL  v1.1 (d) L. Petrov 03-NOV-2025 ###  *
# *                                                                      *
# ************************************************************************
*/
char *putchr;
