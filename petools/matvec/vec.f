...
! *                                                                      *
! *  ###  12-Dec-96     COPY_V     v1.0  (d)  L. Petrov  12-Dec-96  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  12-Dec-96    COPY_R8     v1.0  (d)  L. Petrov  12-Dec-96  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  12-Dec-96    COPY_R4     v1.0  (d)  L. Petrov  12-Dec-96  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  02-AUG-97     COPY_I4    v1.0  (d)  L. Petrov  02-AUG-97  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  10-OCT-2017   NOUT_I8    v1.0  (d)  L. Petrov 10-OCT-2017 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*8  N, VEC(N)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  12-Dec-96     NOUT_I4    v1.0  (d)  L. Petrov  12-Dec-96  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N, VEC(N)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  12-Dec-96     NOUT_I2    v1.0  (d)  L. Petrov  12-Dec-96  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  12-Dec-96     NOUT_R8    v1.0  (d)  L. Petrov  12-Dec-96  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  12-Dec-96     NOUT_R4    v1.0  (d)  L. Petrov  12-Dec-96  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  02-JAN-97      TM_II     V1.0 (d)   L. Petrov  02-JAN-97  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  N, J1, J2
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  02-JAN-97     MAT_SI     V1.0 (d)   L. Petrov  02-JAN-97  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  02-JAN-97     MAT_IS     V1.0 (d)   L. Petrov  02-JAN-97  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  N, LA, J1, J2
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  21-Jan-97   ADDMAT_IT    v1.1  (d)  L. Petrov  23-Jan-97  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  16-JUL-99  ADDMAT_IT_S   v1.0  (d)  L. Petrov  16-JUL-99  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  24-FEB-97    REDIM_MAT    v1.0 (d)  L. Petrov  25-FEB-97  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  18-AUG-98     NORM_VEC   v1.2  (d)  L. Petrov 29-OCT-2005 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 20-JAN-1989      VM83     v1.0 (d)  L. Petrov  20-JAN-1989 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 05-JAN-1999   R8ELEM_ADD  v1.0  (d)  L. Petrov  28-FEB-2022 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      REAL*8     VEC1(*), VEC2(*)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 05-JAN-1999   R8ELEM_SUB  v1.0  (d)  L. Petrov  28-FEB-2022 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      REAL*8     VEC1(*), VEC2(*)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  31-AUG-99      TM83      v1.0  (d)  L. Petrov  31-AUG-99  ###  *
! *                                                                      *
! ************************************************************************
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  12-Dec-96   CP_VV_V      v1.0  (d)  L. Petrov   12-Dec-96 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 10-JUL-2003 VEC_MULT_CONSTANT v1.0 (d) L. Petrov 10-JUL-2003 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  COUNT, J1
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 10-JUL-2003  VEC_MULT_VECTOR  v1.0 (d) L. Petrov 10-JUL-2003 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  COUNT, J1
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 10-JUL-2003 VEC_MULT_VECTOR_I v1.0 (d) L. Petrov 19-MAY-2004 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 07-JUN-2004  MULTI_ADD_3  v1.0 (d)  L. Petrov  07-JUN-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 07-JUN-2004  MULTI_MUL_3  v1.0 (d)  L. Petrov  07-JUN-2004 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  N
