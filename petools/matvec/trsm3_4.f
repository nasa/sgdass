...
!
      IF ( N .EQ. 1 ) THEN
           B( 4 ,1) = B( 4 ,1) / A( 10 )
           B( 3 ,1) = B( 3 ,1) - A( 9 ) * B( 4 ,1)
           B( 3 ,1) = B( 3 ,1) / A( 6 )
           B( 2 ,1) = B( 2 ,1) - A( 8 ) * B( 4 ,1)
           B( 2 ,1) = B( 2 ,1) - A( 5 ) * B( 3 ,1)
           B( 2 ,1) = B( 2 ,1) / A( 3 )
           B( 1 ,1) = B( 1 ,1) - A( 7 ) * B( 4 ,1)
        ...
        ELSE IF ( N .EQ. 2 ) THEN
           ...
           B( 4 ,2) = B( 4 ,2) / A( 10 )
           B( 3 ,1) = B( 3 ,1) - A( 9 ) * B( 4 ,1)
           B( 3 ,2) = B( 3 ,2) - A( 9 ) * B( 4 ,2)
           B( 3 ,1) = B( 3 ,1) / A( 6 )
           B( 3 ,2) = B( 3 ,2) / A( 6 )
           B( 2 ,1) = B( 2 ,1) - A( 8 ) * B( 4 ,1)
           B( 2 ,2) = B( 2 ,2) - A( 8 ) * B( 4 ,2)
           B( 2 ,1) = B( 2 ,1) - A( 5 ) * B( 3 ,1)
           B( 2 ,2) = B( 2 ,2) - A( 5 ) * B( 3 ,2)
           B( 2 ,1) = B( 2 ,1) / A( 3 )
           B( 2 ,2) = B( 2 ,2) / A( 3 )
           B( 1 ,1) = B( 1 ,1) - A( 7 ) * B( 4 ,1)
           B( 1 ,2) = B( 1 ,2) - A( 7 ) * B( 4 ,2)
           B( 1 ,1) = B( 1 ,1) - A( 4 ) * B( 3 ,1)
        ...
        ELSE IF ( N .EQ. 3 ) THEN
           ...
           B( 3 ,1) = B( 3 ,1) - A( 9 ) * B( 4 ,1)
           B( 3 ,2) = B( 3 ,2) - A( 9 ) * B( 4 ,2)
           B( 3 ,3) = B( 3 ,3) - A( 9 ) * B( 4 ,3)
           B( 3 ,1) = B( 3 ,1) / A( 6 )
           B( 3 ,2) = B( 3 ,2) / A( 6 )
           B( 3 ,3) = B( 3 ,3) / A( 6 )
           B( 2 ,1) = B( 2 ,1) - A( 8 ) * B( 4 ,1)
           B( 2 ,2) = B( 2 ,2) - A( 8 ) * B( 4 ,2)
           B( 2 ,3) = B( 2 ,3) - A( 8 ) * B( 4 ,3)
           B( 2 ,1) = B( 2 ,1) - A( 5 ) * B( 3 ,1)
           B( 2 ,2) = B( 2 ,2) - A( 5 ) * B( 3 ,2)
        ...
        ELSE
           ...
           CALL DAXPY ( N, -A( 9 ), B( 4 ,1 ), LB, B( 3 ,1 ), LB )
           CALL DSCAL ( N, 1.0D0 / A( 6 ), B( 3 ,1 ), LB )
           CALL DAXPY ( N, -A( 8 ), B( 4 ,1 ), LB, B( 2 ,1 ), LB )
           CALL DAXPY ( N, -A( 5 ), B( 3 ,1 ), LB, B( 2 ,1 ), LB )
           CALL DSCAL ( N, 1.0D0 / A( 3 ), B( 2 ,1 ), LB )
           CALL DAXPY ( N, -A( 7 ), B( 4 ,1 ), LB, B( 1 ,1 ), LB )
