      SUBROUTINE BIN_OPEN_RD ( FNAME, FILDES, STRING )
      IMPLICIT NONE
!
! 1.  BIN_OPEN PROGRAM SPECIFICATION
!
! 1.1 Open a binary file (read only) by calling the C routine fc_open
!
! 1.2 REFERENCES:
!
! 2.  BIN_OPEN_RD INTERFACE
!
! 2.1 Parameter File
!
! 2.2 INPUT Variables:
...
!
! 5.  BIN_OPEN_RD PROGRAM STRUCTURE
!
! Check for legal string option (only 'O' is supported)
!
      IF ( STRING .NE. 'O' ) THEN
           CALL FATAL_W ( 'illegal string', ME )
      ENDIF
!
! --- Open file, and report problem, if any
!
      CALL GET_SYSTEM_CONSTANT ( 'O_RDONLY', OPEN_FLAG, LN )
      MODE_FLAG = 0 
