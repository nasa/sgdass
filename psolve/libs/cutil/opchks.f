      SUBROUTINE OPCHKS( IUNIT,NAME,IERR)
      IMPLICIT   NONE ! Updated by Jim Ryan for I*4 compliance, Sept 2002
!
! 1.  OPCHKS PROGRAM SPECIFICATION
!
...
!
      ...
      IERR = IERR4
!
! Start loop to check for locked file and retry if necessary
!
 ...
 1000   FORMAT(1X,A," LOCKED - SUSPENDING FOR 10 SECONDS.")
        ...
        IERR = IERR4
      END DO
      read(bufstr,'("Opening ",A)')name(1:il)
      call ferr( ierr, bufstr, INT2(0), INT2(0) )
!
      RETURN
      END
