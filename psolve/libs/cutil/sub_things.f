      SUBROUTINE SUB_THINGS()
      IMPLICIT   NONE ! Updated by Jim Ryan for I*4 compliance, Sept 2002
!
! 1.  SUB_THINGS PROGRAM SPECIFICATION
!
! 1.1 Set up the buffer for the call to program ADDER.
!
! 1.2 REFERENCES:
!
! 2.  SUB_THINGS INTERFACE
!
! 2.1 Parameter File
      INCLUDE 'solve.i'
!
...
!   WHO   WHEN   WHAT
!
! 5.  SUB_THINGS PROGRAM STRUCTURE
!
...
!
! Set to subtract and arc from the CGM
!
      ADDRBUF(65)=0 !ADD_OR_SUB
