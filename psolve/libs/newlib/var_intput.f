      SUBROUTINE VAR_INTPUT(INBUF,NUM_ASKED,IARRAY,NUM_GOTTEN,KERR)
!
      IMPLICIT NONE
!
!     Purpose: decodes the input buffer INBUF into up to NUM_ASKED integers,
!        which are returned in the first elements of IARRAY.
!     Written: 7/13/93 by KDB.
!
!     Input variables
!
...
!
      INTEGER*2 IARRAY(*),NUM_GOTTEN,KERR
!
!     Local variables
!
      INTEGER*2 ICT,TRIMLEN,ITEMP
      INTEGER*4  IERR
