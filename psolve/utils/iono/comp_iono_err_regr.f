     ...
     &                               ME_BAS, VTD_CONF_FILE, ISEED, IUER )
! ************************************************************************
! *                                                                      *
! *   Routine COMP_IONO_ERR_REGR
! *                                                                      *
! *  ### 10-APR-2022 COMP_IONO_ERR_REGR v1.0 (c) L. Petrov 11-APR-2022 # *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      ...
      CHARACTER  C_STA(L_STA)*(*), C_BAS(L_BAS)*(*), VTD_CONF_FILE*(*)
...
!
      ...
      IF ( IER .NE. 0 ) THEN
           CALL ERR_LOG ( 3711, IUER, 'COMP_IONO_ERR_REGR', 'Error in an attempt to '// &
...
!
      ...
      IF ( IER .NE. 0 ) THEN
           CALL ERR_LOG ( 3712, IUER, 'COMP_IONO_ERR_REGR', 'Error in an '// &
...
!
      ...
      IF ( IER .NE. 0 ) THEN
           CALL ERR_LOG ( 3713, IUER, 'COMP_IONO_ERR_REGR', 'Error in an '// &
     &         'attempt to write a temporary source file '//FILSOU )
           RETURN 
      END IF
!
...
!
      ...
      IF ( IER .NE. 0 ) THEN
           CALL ERR_LOG ( 3714, IUER, 'COMP_IONO_ERR_REGR', 'Error in an '// &
...
!
      ...
      IF ( IER .NE. 0 ) THEN
           CALL ERR_LOG ( 3715, IUER, 'COMP_IONO_ERR_REGR', 'Error in an attempt '// &
...
!
     ...
     &                 MJD_CEN, TAI_CEN + DUR/2.0D0 + EPS_TIM, IER )
      IF ( IER .NE. 0 ) THEN
           CALL ERR_LOG ( 3716, IUER, 'COMP_IONO_ERR_REGR', 'Error in an '// &
...
!
         ...
         IF ( IER .NE. 0 ) THEN
              CALL ERR_LOG ( 3718, IUER, 'COMP_IONO_ERR_REGR', 'Error in an attempt '// &
...
!
     ...
     &                                            AZ_RATE(J7), EL_RATE(J7), HA_RATE(J7), IER )
                          IF ( IER .NE. 0 ) THEN
                               CALL ERR_LOG ( 3717, IUER, 'COMP_IONO_ERR_REGR', 'Error in an attempt '// &
