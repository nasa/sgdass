...
! *                                                                      *
! * ### 22-AUG-2002  BOXCAR_FILTER v1.0 (d)  L. Petrov  22-AUG-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  NB, N
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 28-JAN-2003     RD_ESM    v1.0 (d)  L. Petrov  28-JAN-2003 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
!
     ...
     &                         WRMS, MEAN_NOTREND, WRMS_NOTREND, CHI, IUER )
! ************************************************************************
! *                                                                      *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 28-JAN-2003  REPEATABILITY  v1.2 (d)  L. Petrov  16-JAN-2026 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
     ...
     &           WRMS, MEAN_NOTREND, WRMS_NOTREND, CHI
      REAL*8     WW, WW_NOT, TIM_0, MEAN_T, &
     &           EPS, TIM_FIRST, TIM_LAST, SHIFT
...
!
 ...
 460               CONTINUE
     ...
     &                          WEI(J5) )**2
              MEAN_NOTREND = MEAN_NOTREND + (VAL(J5) - SHIFT)*WEI(J5)
              WRMS_NOTREND = WRMS_NOTREND + (VAL(J5) - SHIFT)**2*WEI(J5)
              WW_NOT       = WW_NOT + WEI(J5)
              WW = WW + WEI(J5)**2
!
              KP = KP + 1
              TIM(KP) = TIM(J5)
...
!
 ...
 450  CONTINUE
      CHI  = WRMS/(NP - (L_EPC+1))
      WRMS = DSQRT ( WRMS/WW )
      MEAN_NOTREND = MEAN_NOTREND/WW_NOT
      WRMS_NOTREND = DSQRT ( WRMS_NOTREND/WW_NOT - MEAN_NOTREND**2 )
      MEAN_NOTREND = MEAN_NOTREND + SHIFT
!
      CALL ERR_LOG ( 0, IUER )
      RETURN
      END  !#!  REPEATABILITY  #!#
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  28-JAN-2003   RGRW8_BR  v1.0 (d)  L. Petrov  28-JAN-2003  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT  NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 06-FEB-2001 GET_QUAD_TREND v1.0 (d) L. Petrov  06-FEB-2001 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  M, IUER
