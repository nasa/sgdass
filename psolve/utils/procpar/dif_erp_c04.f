...
! *                                                                      *
! * ###  11-APR-2006  DIF_ERP_C04  v1.0 (d)  L. Petrov  11-APR-2006  ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      ...
      PARAMETER  ( MP = 16384, MB_LEAP = 512 )
     ...
     &           EOP1_ERR(MP,3), EOP2_ERR(MP,3)
      CHARACTER  CH_FLAG(MP), BUF_LEAP(MB_LEAP)*256
      ...
      NUMARG = IARGC ()
      IF ( NUMARG .GE. 2 ) THEN
           CALL CLRCH  (    FINAM_ERP )
           CALL CLRCH  (    C04_FILE  )
           CALL GETARG ( 1, FINAM_ERP )
           CALL GETARG ( 2, C04_FILE  )
         ELSE
           WRITE ( 6, * ) ' Usage: dif_erp_c04.e  <erp_file> <c04>'
           CALL EXIT ( 1 )
      END IF
!
      IUER = -1
      CALL RD_ERP ( FINAM_ERP, MP, N_ERP, JD1, XR1_VAL, YR1_VAL, UR1_VAL, &
     &              XR1_ERR, YR1_ERR, UR1_ERR, JD_LAST, IUER )
...
!
      DO 410 J1=1,N_ERP
         TIM1(J1) = (JD1(J1) - J2000__JD)*86400.0D0
         EOP1_VAL(J1,1) = XR1_VAL(J1)*ARCSEC__TO__RAD 
         EOP1_ERR(J1,1) = XR1_ERR(J1)*ARCSEC__TO__RAD 
         EOP1_VAL(J1,2) = YR1_VAL(J1)*ARCSEC__TO__RAD 
         EOP1_ERR(J1,2) = YR1_ERR(J1)*ARCSEC__TO__RAD 
         EOP1_VAL(J1,3) = UR1_VAL(J1)*SEC__TO__RAD 
         EOP1_ERR(J1,3) = UR1_ERR(J1)*SEC__TO__RAD 
 410  CONTINUE 
!
      DO 420 J2=1,N_C04
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 03-NOV-2000     RD_ERP   v1.2 (d)  L. Petrov  29-JUN-2004  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
