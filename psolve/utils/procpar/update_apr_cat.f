...
! *                                                                      *
! *  ### 11-MAR-2008  UPDATE_APR_CAT v1.3 (d) L. Petrov  01-MAR-2023 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
         ...
         END IF
         IF ( BUFA(J1)(76:82) == 'apriori' ) THEN
              BUFA(J1)(75:) = BUFA(J1)(76:) 
         END IF
         IF ( FL_KEEP_ICRFDEF ) THEN
              IF ( IFMT == 1 ) THEN
...
!
     ...
     &                                SIG_MAJ, SIG_MIN, TETA )
                 ...
                 IF ( BUFA(J1)(76:79) == 'rfc_'  ) THEN
                      BUFA(J1)(76:84) = CAT_LABEL(1:9)
                    ELSE
                      BUFA(J1)(76:) = TRIM(CAT_LABEL)//' '//BUFA(J1)(76:)
                 END IF
