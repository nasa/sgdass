...
export TLE_LIB=/opt64/lib 
export TLE_INC=/opt64/include 
...
export SOLVE_LIB_VTD="-L/opt64/lib -lvtd -L/opt64/lib -lspc -L/opt64/lib -L/opt64/lib -ltle -lners" 
...
export MK5_C="/usr/bin/gcc -m64 -mtune=native -fopenmp -fpermissive -fPIC -D LINUX -D LITTLE_ENDIAN -D FORTRAN_TRUE=1 -D FORTRAN_FALSE=0 -D _FILE_OFFSET_BITS=64 -D _LARGEFILE_SOURCE -I ./ -I ../include -I /usr/include -I /usr/local/include -fno-diagnostics-color --std=gnu11 -I /opt64/include" 
export MK5_X11_INCLUDE="/usr/include" 
export MK5_F95="/usr/bin/gfortran -m64 -ffree-form -ffree-line-length-none -fmax-errors=16 -fno-underscoring -fdollar-ok -fopenmp -x f95-cpp-input -finit-integer=-2147483647 -finit-logical=false -finit-real=nan -finit-character=0 -fbacktrace -ftrapv -fPIC -ffpe-trap=overflow,invalid,zero -fexceptions -fPIC -D LINUX -D GNU -D LITTLE_ENDIAN -D ADDRESS__TYPE=INTEGER\(8\) -D ADR_64BIT -D BLAS=openblas -fno-diagnostics-color -fallow-argument-mismatch -Wno-align-commons -J /opt64/module -I ./ -I /f1/progs/psolve_20260812/include -I /opt64/include -Wall -Wno-align-commons -Wno-character-truncation -Wno-conversion -Wno-implicit-interface -Wno-implicit-procedure -Wno-integer-division -Wno-tabs -Wno-unused -fcheck=all -O2 -mavx2" 
export MK5_F95_OPT="/usr/bin/gfortran -m64 -ffree-form -ffree-line-length-none -fmax-errors=16 -fno-underscoring -fdollar-ok -fopenmp -x f95-cpp-input -finit-integer=-2147483647 -finit-logical=false -finit-real=nan -finit-character=0 -fbacktrace -fPIC -mtune=native -D LINUX -D GNU -D LITTLE_ENDIAN -D ADDRESS__TYPE=INTEGER\(8\) -D ADR_64BIT -D BLAS=openblas -fno-diagnostics-color -fallow-argument-mismatch -Wno-align-commons -mavx2 -J /opt64/module -I ./ -I /f1/progs/psolve_20260812/include -I /opt64/include -Wall -Wno-align-commons -Wno-character-truncation -Wno-conversion -Wno-implicit-interface -Wno-implicit-procedure -Wno-integer-division -Wno-tabs -Wno-unused -mavx -O3" 
export MK5_F95_OPTEST="/usr/bin/gfortran -m64 -ffree-form -ffree-line-length-none -fmax-errors=16 -fno-underscoring -fdollar-ok -fopenmp -x f95-cpp-input -finit-integer=-2147483647 -finit-logical=false -finit-real=nan -finit-character=0 -fbacktrace -fPIC -mtune=native -D LINUX -D GNU -D LITTLE_ENDIAN -D ADDRESS__TYPE=INTEGER\(8\) -D ADR_64BIT -D BLAS=openblas -fno-diagnostics-color -fallow-argument-mismatch -Wno-align-commons -mavx2 -J /opt64/module -I ./ -I /f1/progs/psolve_20260812/include -I /opt64/include -Wall -Wno-align-commons -Wno-character-truncation -Wno-conversion -Wno-implicit-interface -Wno-implicit-procedure -Wno-integer-division -Wno-tabs -Wno-unused -mavx -Ofast -ftree-vectorize" 
export MK5_F95_NOOPT="/usr/bin/gfortran -m64 -ffree-form -ffree-line-length-none -fmax-errors=16 -fno-underscoring -fdollar-ok -fopenmp -x f95-cpp-input -finit-integer=-2147483647 -finit-logical=false -finit-real=nan -finit-character=0 -fbacktrace -ftrapv -fPIC -ffpe-trap=overflow,invalid,zero -fexceptions -fPIC -D LINUX -D GNU -D LITTLE_ENDIAN -D ADDRESS__TYPE=INTEGER\(8\) -D ADR_64BIT -D BLAS=openblas -fno-diagnostics-color -fallow-argument-mismatch -Wno-align-commons -J /opt64/module -I ./ -I /f1/progs/psolve_20260812/include -I /opt64/include -Wall -Wno-align-commons -Wno-character-truncation -Wno-conversion -Wno-implicit-interface -Wno-implicit-procedure -Wno-integer-division -Wno-tabs -Wno-unused -fcheck=all -O0 -g" 
...
export SOLVE_ROOT=/f1/progs/psolve_20260812 
...
export SOLVE_SCRATCH_PIMA=/scr/pima 
...
export FOURPACK_PREFIX="/opt64" 
export SOLVE_FFTW_DIR="/opt64" 
export SOLVE_FFTW_INC="-I/opt64/include" 
export SOLVE_FFTW_LIB="-L/opt64/lib -lfftw3 -lfftw3_omp -lfftw3f -lfftw3f_omp" 
export SOLVE_OPT_NOSTRUC="" 
export SOLVE_OS=Linux 
export SOLVE_VERSION=20260812 
export 0022=
