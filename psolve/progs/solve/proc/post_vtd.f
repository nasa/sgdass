...
! *                                                                      *
! *  ### 19-APR-2006    POST_VTD   v2.6 (d)  L. Petrov  13-DEC-2025 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
      ...
      MOD_ATM_PRES(1) = DER_DEL(VTD__SUR_PRS1) 
      MOD_ATM_PRES(2) = DER_DEL(VTD__SUR_PRS2) 
      MOD_WPR_PRES(1) = DER_DEL(VTD__SUR_PWP1) 
      MOD_WPR_PRES(2) = DER_DEL(VTD__SUR_PWP2) 
      IONO_APR_DEL    = DER_DEL(VTD__IONO1) - DER_DEL(VTD__IONO2)
...
!
                TEC_APR(1)    = DER_DEL(VTD__TEC1)
                TEC_APR(2)    = DER_DEL(VTD__TEC2)
           END IF
        ELSE 
           TEC_APR(1)    = DER_DEL(VTD__TEC1)
           TEC_APR(2)    = DER_DEL(VTD__TEC2)
...
!!    write ( 6, * ) 'POST-VTD-209  ind_obs= ', int2(ind_obs), ' sta= ', sta1, ' ', sta2, ' tec_apr= ', tec_apr ! %%%%
      CALL ERR_LOG ( 0, IUER )
      RETURN
