...
! *                                                                      *
! *  ### 07-NOV-2007    TPD_PUT    v1.4 (d)  L. Petrov  01-APR-2026 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'solve.i'
...
!
      ...
      TPD%DELAY(IOBS)%DER(26) = MOD_ATM_PRES(1)
      TPD%DELAY(IOBS)%DER(27) = MOD_ATM_PRES(2)
      TPD%DELAY(IOBS)%DER(28) = MOD_WPR_PRES(1)
      TPD%DELAY(IOBS)%DER(29) = MOD_WPR_PRES(2)
!
