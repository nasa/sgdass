...
! *                                                                      *
! * ### 01-DEC-2004  REPA_LOAD_OBS  v1.6 (d)  L. Petrov  05-NOV-2025 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
!
         ...
         REP%OBS(J1)%DTEC           = DTEC_ADJ
         REP%OBS(J1)%DTEC_ERR       = DTEC_ERR
         REP%OBS(J1)%DTEC_APR       = TEC_APR(1) - TEC_APR(2)
         REP%OBS(J1)%IONO_APR_DEL   = IONO_APR_DEL
