...
!   pet   2026.03.28  Updated the code to support SEG_POST2026 listing option as well
!   pet   2026.03.30  Added the message in a case of session-wide EOPS were not estimated
!
...
!
                              ...
                              ELSE IF ( SEG_LISTING_STYLE == SEG_POST2005_SPOOL__FMT .OR. &
     &                                  SEG_LISTING_STYLE == SEG_POST2026_SPOOL__FMT      ) THEN
...
!
     ...
     &                                         JDATE_ALL_MID-2400000.5D0
                   ELSE
                     IF ( TROT_CUR > 1.0D0 ) THEN
                          WRITE ( 23, '(A,F12.6)' ) ' EOP epoch (TDT)  MJD: ', &
     &                                              TROT_CUR - 2400000.5D0
                        ELSE
                          WRITE ( 23, '(A)' ) 'Session-wise EOPs were not estimated for session '//DBNAME_CH
                     END IF
                END IF
           END IF
      END IF
