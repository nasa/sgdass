...
! *                                                                      *
! * ### 21-NOV-2005  GETDB_FILL_SOCOM v1.5 (d) L. Petrov 18-NOV-2025 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
     ...
     &         'inquiring lcode BITSAMPL' )
      ...
      IF ( CLASS .NE. 0 ) THEN
!
! -------- Set flag: DTEC is computed by the fringe fitting procss, 
! -------- and group delay is ionosphere free
!
           FL_DTEC_FF = 1
         ELSE
!
! -------- Set flag: DTEC was not computed
!
           FL_DTEC_FF = 0
      END IF
!
