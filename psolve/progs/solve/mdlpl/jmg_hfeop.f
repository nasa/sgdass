      SUBROUTINE init_hf_eop(hfjmg_file_namr,num_model)
      implicit none
!
!     modifications:
!
...
! GIVEN A FILE WITH EOP PARAMETERS, MAKE HF EOP.
      ...
      character*(*) hfjmg_file_namr
      integer*2 num_model,iut1,ixy,i
!
      common /eop/num_ut1,num_xy,ut1_val,xy_val
      common /eop/ut1_arg,xy_arg
!
!
      open(1,file=hfjmg_file_namr,status='old',iostat=ios)
      if(ios.ne.0) then
        write(6,'("init_hf_eop: Unable to open file: ",a)') hfjmg_file_namr
        stop 'init_hf_eop:1'
      endif
!
10    continue
