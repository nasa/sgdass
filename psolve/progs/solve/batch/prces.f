...
!   pet  2025.12.08  Fixed ISLTY2 for the glboal only solution
!
...
!
                      ...
                      ELSE
                        IF ( ISLTY2 .EQ. 'F' ) THEN
#ifdef DEBUG
   write ( 6, * ) 'prces-836    GLBMEM%L_GPA= ', GLBMEM%L_GPA, ' db= ', DBNAME_MES, ' L_GPA= ', GLBMEM%L_GPA, ' ARCNUM= ', ARCNUMnum_uer_part, arc_user_part: ', num_user_part, arc_user_part ! %%%%
#endif
!
! ------------------------- Forward run
!
