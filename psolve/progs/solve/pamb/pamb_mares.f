...
! *                                                                      *
! *  ###  12-NOV-1997  PAMB_MARES  v3.10 (d)  L. Petrov 02-MAR-2022 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'solve.i'
...
!
     ...
     &                      RES(J3)%PSF_DEL
!!    write ( 6, * ) 'PAMB_MARES-307: j3= ', j3, ' d3= ', obsbas(j3)%tauph_obs, obsbas(j3)%taugr_obs, res(j3)%psf_del ! %%%%%%%%%%%%%
...
!
     ...
     &                  'AMB_UPDATE' )
                    RETURN 
               END IF
!!    write ( 6, * ) 'PAMB_MARES-367: j3= ', j3, ' IAMB_X= ', IAMB_X, ' ta= ', TAU_PX_OC,   OBSBAS(J3)%FREQ_OBSV_PH  ! %%%%%
...
!
          IF ( F_ONEBAND ) THEN
!
! ----------- 3a. Produce one-band X-band phase delay observable from group
! ----------- delay observables and post-fit residuals
!
