...
! *                                                                      *
! * ### 24-JAN-2010 UPDATE_THEOR_DELAY v1.3 (d) L. Petrov 17-NOV-2025 ## *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
...
!
         ...
         END IF
!
!!    write ( 6, * ) 'UPDATE_THEOR_DELAY-481  ind_obs= ', int2(j3), ' iono_apr_del = ', iono_apr_del ! %%%
