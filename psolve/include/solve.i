...
!
! Automatically generated on 2026.08.18_15:26:30 from psolve_templ.i
!     Last update:  2025.11.17_17:37:22
!
...
!  pet    2025.05.03  Raised MAX_SCA from 3072 tp 128*1024
!  pet    2025.06.04  Added new field to SPE__TYPE
!  pet    2025.07.07  Added new constant STA_POS_EVO__LABEL
!  pet    2025.11.17  Increased JOBSREC_BLOCKS from  10 to   11
!  pet    2025.12.12  Increased JSOCOM_BLOCKS from 582 to 615
!  pet    2025.12.12  Added MAX4_OBS_BSL and MAX4_OBS_STA constants
!  pet    2026.04.01  Increased TPD_NDER rom 25 to 29
!  pet    2026.04.02  Added constant METEO__LABEL
!
!=====================
!
...
!
      ...
      INTEGER*4 MAX4_BRK, MAX4_EOP, MAX4_FRQ, MAX4_HFE, MAX4_SIT, MAX4_SRC, MAX4_BSL, MAX_BND, MAX4_OBS_STA, MAX4_OBS_BSL
      PARAMETER ( MAX_STA=512,             & ! max total number of station
     &            MAX_STA_CMP=MAX_STA*3,   & ! max total number of st. components
     &            MAX4_OBS_STA=528,        & ! max number of stations for observed sessions
     &            MAX4_OBS_BSL=528,        & ! max number of baselines for observed sessions
...
!
      ...
      PARAMETER  ( SOLVE_VERSION   = "20260812" )
      PARAMETER  ( CGM_DIR         = "/scr/psolve/cgm_dir" )
      PARAMETER  ( PSOLVE_ROOT     = "/f1/progs/psolve_20260812" )
      ...
      PARAMETER  ( SOLVE_PIMA_DIR  = "/scr/pima" )
...
!
      INTEGER*4   MAX_SCA
      PARAMETER ( MAX_SCA = 128*1024 ) ! maximal number of scans in one session
!
      INTEGER*4   JOBSREC_BLOCKS, JOBSREC_WORDS, JOBSREC_BYTES
      PARAMETER ( JOBSREC_BLOCKS = 11, &
...
!
	  ...
	  REAL*8     CNS_VEL_SIGMA
          ...
          REAL*8     TAI_CNST_STA(2)
          INTEGER*4  MJD_CNST_STA(2)
          REAL*8     TAI_CNST_VEL(2)
          INTEGER*4  MJD_CNST_VEL(2)
	  INTEGER*4  IND_KNOT_BEG_CNST_STA
	  INTEGER*4  IND_KNOT_END_CNST_STA
	  INTEGER*4  IND_KNOT_BEG_CNST_VEL
	  INTEGER*4  IND_KNOT_END_CNST_VEL
!
	  INTEGER*4  K_NOD  ! Total number of knots plus the number of multiplicities
...
!
	  ...
	  INTEGER*4  DEGREE
	  INTEGER*4  L_NOD
	  LOGICAL*4  FL_CHECK_OVER  ! Flag: should the node pass over be checked
...
!?      PARAMETER  ( TPD__LABEL = 'TPD Format version of 2009.06.01' )
      PARAMETER  ( TPD__LABEL = 'TPD Format version of 2026.04.01' )
      INTEGER*4    TPD__NDER
      PARAMETER  ( TPD__NDER = 29 )
!
      TYPE       TPD_STA__TYPE
	 REAL*8     VSITEC(3)
	 REAL*8     VSITEV(3)
...
!
      CHARACTER    LABEL__AOC*68, LABEL__IONO*82, LABEL__EDIT*58, LABEL__ADDW*56, LABEL__SCAW*88, &
...
! 
      ...
      CHARACTER    STA_POS_EVO__LABEL*52
      PARAMETER  ( STA_POS_EVO__LABEL = '# Station Position Evolution.   Format of 2025.07.07' )
      CHARACTER    METEO__LABEL*60
      PARAMETER  ( METEO__LABEL = '# Meteorological Output Data.  Format revision of 2026.04.02' )
!
