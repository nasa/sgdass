...
" Station:      WESTFORD   Wf
"
" Template last modification date: 2024.07.08_09:05:48
...
"=================================
"
define  preses_@mode@   00000000000x
" Duration: 0 sec
...
" set the udc
sy=popen 'be_client -h udca -c udc_lo=@udc_lo@   2>&1'  -n udcca
sy=popen 'be_client -h udcb -c udc_lo=@udc_lo@   2>&1'  -n udccb
sy=popen 'be_client -h udcc -c udc_lo=@udc_lo@   2>&1'  -n udccc
sy=popen 'be_client -h udcd -c udc_lo=@udc_lo@   2>&1'  -n udccd
...
sy=popen 'udceth0 udca @udc_luff @20 20' -n udcca &
sy=popen 'udceth0 udcb @udc_luff  20 20' -n udccb &
sy=popen 'udceth0 udcc @udc_luff  20 20' -n udccc &
sy=popen 'udceth0 udcd @udc_luff  20 20' -n udccd &
enddef
"
"=================================
"
define  setscan_@mode@       00000000000x
" Duration: 0 sec
pcalon
tpicd=stop
rdbebb
...
"=================================
"
define  preob_@mode@        00000000000x
" Duration: 0 sec
onsource
track
rdbe_atten=
...
"=================================
"
define  midob_@mode@         00000000000x
" Duration: 0 sec
!+4s
onsource
track
...
"=================================
"
define  postob_@mode@        00000000000x
" Duration: 2 sec
mk6=msg?;
data_valid=off
mk6=record=off;
...
"=================================
"
define  postses_@mode@        00000000000x
" Duration: 0 sec
stop_mlog
" End of schedule
sched_end
