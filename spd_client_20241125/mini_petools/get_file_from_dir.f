...
! *                                                                      *
! * ### 20-AUG-2002 GET_FILE_FROM_DIR v2.6 (c) L. Petrov 06-APR-2014 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      ...
      ADDRESS__TYPE IP
      LOGICAL*1  FL_LNK
      INTEGER*4, EXTERNAL :: I_LEN, ILEN, LINDEX, FOR_STAT, FOR_LSTAT
      ADDRESS__TYPE, EXTERNAL :: FUNC_OPENDIR, FUNC_READDIR, CLOSEDIR
!
