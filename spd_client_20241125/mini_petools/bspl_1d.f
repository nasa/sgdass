...
! *                                   case of error.                     *
! *                                                                      *
! *  ### 02-MAR-2009   BSPL_1D_CMP  v2.0 (c) L. Petrov  19-APR-2009 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      ...
      DO 410 J1=1-DEG,M-1
         DO 420 J2=MAX(J1+1,0),MIN(J1+DEG,M+1)
            IF ( J2 == 0 ) THEN
               ...
               ELSE IF ( J2 == M+1 ) THEN
                 EQU = BSPL_DER ( M, ARG_ARR, DEG, J1, ARG_ARR(M)*(1.0E0-EPS) )
               ELSE 
                 IF ( J2 == M ) THEN
                      EQU = BSPL_VAL ( M, ARG_ARR, DEG, J1, ARG_ARR(J2)*(1.0E0-EPS) )
                    ELSE
