...
! *                                                                      *
! *  ### 09-JAN-2015  SPD_CLI_INIT  v1.1 (d)  L. Petrov  31-MAR-2015 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 10-JAN-2015  SPD_CLI_PING  v1.0 (d)  L. Petrov 10-JAN-2015 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ## 10-JAN-2015  SPD_CLI_SHUTDOWN  v1.0 (d)  L. Petrov 10-JAN-2015 ## *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 22-JAN-2015  SPD_CLI_GET_2PD  v1.0 (d) L. Petrov 22-JAN-2015 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 24-MAR-2015  SPD_CLI_LEN  v1.0 (d)  L. Petrov  24-MAR-2015 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ### 24-MAR-2015  SPD_GET_CLI_LIB v1.0 (d) L. Petrov  24-MAR-2015 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd.i'
...
! ------------------------------------------------------------------------
!
      SUBROUTINE SPD_CLI_QUIT ( SPD_CLI )
! ************************************************************************
! *                                                                      *
! *   Routine SPD_CLI_QUIT initizalies SPD_CLI object.                   *
! *                                                                      *
! *   Copyright (c) 1975-2025 United States Government as represented by *
! *   the Administrator of the National Aeronautics and Space            *
! *   Administration. All Rights Reserved.                               *
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 10-JAN-2026  SPD_CLI_QUIT  v1.0 (d)  L. Petrov  10-JAN-2026 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd.i'
      ...
      TYPE     ( SPD_CLI__TYPE ) :: SPD_CLI
!
      CALL CLRCH ( SPD_CLI%SERVER_NAME  )
      CALL CLRCH ( SPD_CLI%SPD_CLI_CONF )
      CALL CLRCH ( SPD_CLI%SPD_PATH     )
      CALL CLRCH ( SPD_CLI%SPD_TYPE_1   )
      CALL CLRCH ( SPD_CLI%SPD_TYPE_2   )
      SPD_CLI%READ_TIMEOUT = 0.0D0
      SPD_CLI%CONN_TIMEOUT = 0.0D0
!
      SPD_CLI%SERVER_PORT = 0
      SPD_CLI%STATUS = CLI__UNDF
      SPD_CLI%SOCK_FD = 0
      SPD_CLI%REM_FD = 0
      CALL CLRCH ( SPD_CLI%REM_IP_STR )
      CALL CLRCH ( SPD_CLI%CONF_FILE  )
      CALL CLRCH ( SPD_CLI%SEND_COM%VERB )
      CALL CLRCH ( SPD_CLI%recv_COM%VERB )
      SPD_CLI%SEND_COM%LEN = 0 
      SPD_CLI%RECV_COM%LEN = 0 
!
      RETURN
      END  SUBROUTINE  SPD_CLI_QUIT  !#!#
