...
! *   considered as a Gaussian layer at heiht HL with full width half    *
! *   maximum ( FWHM ) WL. The mapping function is defined in a range of *
! *   elevations [EL_MIN, EL_MAX]. The mapping functio nis computed      *
! *   under assumptions:                                                 *
! *     1) the Earth is sperical;                                        *
...
! *                         Units: meters.                               *
! *     WL ( REAL*8    ) -- The full width half maximum layer thickess.  *
! *                         Units: meters.                               *
! * EL_MIN ( REAL*8    ) -- Minimum elevation angle. Units: rad.         *
! * EL_MAX ( REAL*8    ) -- Miximum elevation angle. Units: rad.         *
! *  M_DEG ( INTEGER*4 ) -- Degree of the B-spline expnasion.            *
! *                         Recommended value: 3.                        *
...
! *                                                                      *
! * # 16-AUG-2014 SPD_GAUSSIAN_LAYER_MF v1.0 (d) L. Petrov 16-AUG-2014 # *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
