...
! ************************************************************************
! *                                                                      *
! *   Routine  SPD_INIT  initializes internal data structure of object   *
! *   SPD.                                                               *
! *                                                                      *
...
! *                                                                      *
! *  ### 10-DEC-2007    SPD_INIT   v1.0 (d)  L. Petrov  10-DEC-2007 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd.i'
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! * ## 31-JAN-2014 SPD_CHECK_SHARE_FILE v1.0 (d) L. Petrov 31-JAN-2014 # *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INCLUDE   'spd_local.i'
