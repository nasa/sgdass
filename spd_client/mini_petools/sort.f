...
! *                                                                      *
! *  ###  31-JUL-1989  SORT_I    v1.0 (d) L. Petrov  24-MAY-1990    ###  *
! *                                                                      *
! ************************************************************************
        INTEGER*4 LIS(L)
        IF ( L .LE. 1 ) RETURN 
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  31-JUL-1989  SORT_I8   v1.0 (d) L. Petrov  31-OCT-2005    ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE 
        INTEGER*8 L
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  31-JUL-1989   SORT_R4   v1.0  (d) L. Petrov  01-DEC-2013  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE 
        INTEGER*4  L
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  28-SEP-98    SORT_IA     v1.0  (d)  L. Petrov  28-SEP-98  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        INTEGER*4  L, LIS(L)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  31-JUL-1989    SORT_I2   v1.0 (d) L. Petrov  30-MAR-1992  ###  *
! *                                                                      *
! ************************************************************************
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  31-JUL-1989    SORT8    v 1.0  (d) L. Petrov 12-JUL-1995  ###  *
! *                                                                      *
! ************************************************************************
        INTEGER*4 N, J1, NL
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  31-JUL-89     SORT83    V1.0  (d) L. Petrov  03-NOV-1998  ###  *
! *                                                                      *
! ************************************************************************
        INTEGER*4 N, J1, NL
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  31-JUL-89     SORT84    V1.0  (d) L. Petrov  25-AUG-2009  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE 
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  03-DEC-2004  SORT83I    V1.0  (d) L. Petrov  03-DEC-2004  ###  *
! *                                                                      *
! ************************************************************************
        INTEGER*4 N, J1, NL
        REAL*8    X(N), Y(N), Z(N), XTEMP, YTEMP, ZTEMP
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  31-JUL-1989   SORT_R8   v 1.0  (d) L. Petrov 12-JUL-1995  ###  *
! *                                                                      *
! ************************************************************************
        INTEGER*4 N, J1, NL
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  14-MAY-1998    SORT_CH  v1.0  (d)  L. Petrov  14-MAY-1998 ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  07-JAN-2006 SORT_FAST_I4  v1.0  (d) L. Petrov  07-JAN-2006 ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        INTEGER*4  L, LIS(L)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 07-JAN-2006  SORT_FAST_I8  v1.0  (d) L. Petrov  07-JAN-2006 ### *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        INTEGER*8  L
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 07-JAN-2006  SORT_FAST_R4  v1.0  (d) L. Petrov  07-JAN-2006 ### *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        INTEGER*4  L4
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 07-JAN-2006  SORT_FAST_R8  v1.0  (d) L. Petrov  07-JAN-2006 ### *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        INTEGER*8  L8
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 07-FEB-2008  SORT_FAST_CH  v1.0  (d) L. Petrov  07-FEB-2008 ### *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        INTEGER*4  L
