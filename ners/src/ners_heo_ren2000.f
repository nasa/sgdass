      SUBROUTINE NERS_HEO_REN2000 ( IPAR, TARG_TDB, UT1_M_TDB, E1, E2, DPSI, DEPS, &
     &                         E1_RATE, E2_RATE, DPSI_RATE, DEPS_RATE, &
     &                         CROSS_NUT_E3  )
! ************************************************************************
! *                                                                      *
! *   Routine  NERS_HEO_REN2000  computes angles of small rotation of    *
...
! *   angles DPSI, DEPS according to the NERS_HEO_REN2000 nutation       *
! *   expansion. This routine computes rate of change of E1,E2 or        *
! *   DEPS,DPSI as well.                                                 *
! *                                                                      *
! *   References:                                                        *
! *                                                                      *
...
! *                             Unit: rad.                               *
! *                                                                      *
! * ### 06-OCT-2003 NERS_HEO_REN2000  v3.1 (c) L. Petrov 05-SEP-2006 ### *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'nut_const.i'
...
!
      RETURN
      END  SUBROUTINE  NERS_HEO_REN2000  !#!#
