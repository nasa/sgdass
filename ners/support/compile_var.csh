...
# *                                                                      *
# * ### 02-SEP-2002 compile_var.csh v1.56 (d) L. Petrov 29-MAY-2025 ###  *
# *                                                                      *
# ************************************************************************
setenv LANG   C
setenv LC_ALL C
...
#
     ...
     if ( `$PETOOLS_ROOT/support/version_equal_or_greater.csh $cc_version "15.1.0"` == 1 ) then
          set f95_flags_04 = ( \
                               -Wall \
                               -Wno-align-commons \
          ...
          set copt = ( $copt --std=gnu11 )
     endif
     setenv COPT   "$copt"
#
# -- The differences between LDOPT and LDOPT_CLINK, is that LDOPT_CLINK is 
...
#
     unsetenv FOPT
     setenv MK5_F95_NOOPT  "$MK5_FC  $f95_flags_base $f95_flags_02 $f95_flags_03     $f95_flags_04 $f95_flags_no_opt"
     setenv MK5_F95        "$MK5_FC  $f95_flags_base $f95_flags_02 $f95_flags_03     $f95_flags_04 $f95_flags_norm_opt $f95_flags_extra_opt"
     setenv MK5_F95_OPT    "$MK5_FC  $f95_flags_high_opt $f95_flags_02 $f95_flags_03 $f95_flags_04 $f95_flags_high_extra_opt"
     setenv MK5_F95_OPTEST "$MK5_FC  $f95_flags_high_opt $f95_flags_02 $f95_flags_03 $f95_flags_04 $f95_flags_highest_extra_opt"
     setenv MK5_C          "$MK5_CC  $COPT"
     setenv MK5_LINK       "$MK5_FC  $LDOPT"
