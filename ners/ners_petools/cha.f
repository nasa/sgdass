...
! *                                                                      *
! *  ### 17-JAN-1989               v1.0 (d)  L. Petrov  14-JUL-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  ILEN
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 17-JAN-1989     I_LEN     v1.0 (d)  L. Petrov  14-JUL-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  I_LEN
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 17-JAN-1988     CLRCH     v1.0 (d)  L. Petrov  10-JUL-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      CHARACTER  STR*(*)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 17-JAN-1989      NOUT     v1.0 (d)  L. Petrov  14-JUL-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  NBYTES
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 16-DEC-1996    LIB$SCANC   v1.0 (d) L. Petrov  14-JUL-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      CHARACTER  STR*(*)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 16-DEC-1996    LIB$SPANC   v1.0 (d) L. Petrov  14-JUL-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  LIB$SPANC
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 16-DEC-1996    LIB$SKPC   v1.0 (d)  L. Petrov  14-JUL-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  LIB$SKPC
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  22-DEC-96   LIB$MOVC3    v3.0  (d)  L. Petrov 27-JUN-2001 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  LENB
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  22-DEC-96   LIB$MOVC8    v3.1  (d)  L. Petrov 17-APR-2014 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*8  LENB_I8
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  04-MAY-98   GET_STRING0   v1.0 (d)  L. Petrov  04-MAY-98  ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 09-JUN-2009     FINDEX    v1.0 (d)  L. Petrov  09-JUN-2009 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE 
      INTEGER*4  FINDEX
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ### 18-MAR-1991    UNINDEX    v1.0 (d)  L. Petrov  02-JUL-2002 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INTEGER*4  UNINDEX
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  08-JAN-91      INCH     v1.0     (d) L. Petrov 16-FEB-96  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        CHARACTER  CH*(*), STR*11
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  10-JAN-1996    IINCH    v1.1  (d) L. Petrov  08-FEB-1996  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  27-JAN-2005    IINCH8   v1.0  (d) L. Petrov  27-JAN-2005  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  16-JAN-89      CHIN      v1.0  (d)  L. Petrov  28-OCT-93  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
!!        INTEGER*4 CHIN
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  16-JAN-89     CHIN8      v1.0  (d)  L. Petrov  28-OCT-93  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        CHARACTER CH*(*), CHH*24
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  21-DEC-90      CHASHL    v1.0  (d)  L. Petrov  21-DEC-90  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        CHARACTER  STR*(*)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  21-DEC-1990    CHASHR  v1.0  (d)  L. Petrov  21-DEC-1990  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        CHARACTER  STR*(*)
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  23-JUL-91      REPEAT    v1.0  (d)  L. Petrov  23-JUL-91  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        CHARACTER  SUBSTR*(*), STR*(*)
...
! *                                account in both TEXT and SAMPL.       *
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  21-JAN-92     LTM_DIF    v1.3  (d)  L. Petrov  04-OCT-99  ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
        INTEGER*4  LTM_DIF
...
! *   License: NASA Open Source Software Agreement (NOSA).               *
! *                                                                      *
! *  ###  27-FEB-1992    EXWORD   v5.3  (d)  L. Petrov  15-AUG-2005 ###  *
! *                                                                      *
! ************************************************************************
        IMPLICIT   NONE
