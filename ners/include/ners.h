...
#define NERS__CLEA 1495478323
#define NERS__ALL   126054782 
#define NERS__LEN      38056
#define NERS__CONFIG "/opt64/share/ners.config"
...
extern void cners_azelha_comp ( struct ners_struct * ners, double time_tai_beg, double coo_trs[],
                                double ra, double dec, char * refr, double * az, double * el, 
                                double * ha, double * az_rate, double * el_rate, double * ha_rate, 
                                int * iuer ) ;

extern void cners_radec_comp  ( struct ners_struct * ners, double tim_tai, double coo_trs[], 
                                double az, double el, char * refr_mode, 
