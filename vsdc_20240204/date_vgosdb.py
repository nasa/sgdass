...
# ************************************************************************
# *                                                                      *
# *   Routine date_vgosdb.py returns a strings with two UTC dates        *
# *   extracted from the VGOSDB database.                                *
...
# *                                                                      *
# * ### 29-JUL-2019  date_vgosdb.py v1.0 (c) L. Petrov 30-JUL-2019 ###   *
# *                                                                      *
# ************************************************************************
import sys, os, signal
from   vsdc_misc          import *
from   vsdc_date_vgosdb   import *
...
def main():
    if ( len(sys.argv) < 2 ):
         print ( "Usage: date_vgosdb.py file_name" )
         exit  ( 1 )
...
#
    ...
    (date_first, date_last) = vsdc_date_vgosdb ( file_name )
    if ( date_first == None ):
         exit ( 1 )
