...
# *                                                                      *
# *  ###  12-OCT-2012 config.csh  v7.7   (d) L. Petrov 22-FEB-2025  ###  *
# *                                                                      *
# ************************************************************************
#
...
if ( -d  $TLE_PREFIX/include == 0 ) then
     echo "malo config: tle include directory $TLE_PREFIX/include was not found"
     echo "malo config: Please install tle"
     exit 1
endif
#
if ( -f  $TLE_PREFIX/include/tle_local.i == 0 ) then
     echo "malo config: tle version file $TLE_PREFIX/include/tle_local.i was not found"
     echo "malo config: Please install tle"
     exit 1
endif
...
$MALO_ROOT/support/check_tle_version.csh >>& $CONF_LOG
if ( $status != 0 ) then
...
make -f $MALO_ROOT/support/check_tle_version.mak clean 
echo "ok" | tee -a  $CONF_LOG
#
