...
# *                                                                      *
# * # 29-JUN-2017 print_num_grid_points v1.0 (c) L. Petrov 29-JUN-2017 ## *
# *                                                                      *
# ************************************************************************
...
def long_number_str ( num ):
    ...
    if ( il > 15 ):
         ...
         str = str[0:il-6] + "," + str[il-6:il-3] + "," + sestr[il-3:il]
    elif ( il > 4 ):
...
if ( len(buf[0].split()) > 0 ):
     num_grids = float(buf[0].split()[0])
else:
     num_grids = 0

#
#  We count got-410c, fes2012, equil01, eqiil02
#
num_grid_points = (num_grids + 34 +88 + 8 + 26)*float(5401)*float(10800)

num_grird_points_str = long_number_str ( num_grid_points )

print ( num_grird_points_str )
