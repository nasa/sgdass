...
# *   AOD1B products.                                                    *
# *                                                                      *
# * # 30-APR-2015 compute_mpiom06_spr.csh v1.1 (c) L. Petrov 05-APR-2018 # *
# *                                                                      *
# ************************************************************************
#
...
set mpiom_stokes_orig = /imls/orig_data/mpiom06/orig
set mpiom_stokes_asc  = /imls/orig_data/mpiom06/asc
set mpiom_pres_dir    = /t0/heb/mpiom06
set lis_file          = /tmp/mpiom06.lis
set cnf_file          = nto_mpiom06_load_d2699_nomodel.cnf
#
