...
# *                                                                      *
# * ### 23-DEC-2013   lws_loading.py v3.6 (c) L. Petrov  08-JUN-2026 ### *
# *                                                                      *
# ************************************************************************
"""
...
#
    ...
    if ( not os.path.isfile(lws_pres_heb) ):
         print ( "Cannot find input lws pressure file", lws_pres_heb )
         exit ( 1 )
...
#
    ...
    if ( mode[8:9] == "1" ):
#
# ------ Compute integral of the loading
#
