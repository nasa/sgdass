...
# *                    9-th: Compute integral of loading over the Earth. *
...
# *                                                                      *
# * ### 22-APR-2016  atm_loading.py  v2.6 (c) L. Petrov  08-JUN-2026 ### *
# *                                                                      *
# ************************************************************************
"""
...
#
    ...
    if ( ivrb >= 4 ):
         ...
         print ( "spr_file              = ", spr_file              )
         print ( "atm_love_pres_file    = ", atm_love_pres_file    )
         print ( "atm_dspl_nosc_heb     = ", atm_dspl_nosc_heb     )
         print ( "atm_dspl_sc_heb       = ", atm_dspl_sc_heb       )
         print ( "atm_d1_dspl_heb       = ", atm_d1_dspl_heb       )
         print ( "atm_spr_pref          = ", atm_spr_pref          )
         print ( "atm_spr_file          = ", atm_spr_file          )
         print ( "atm_dspl_nc           = ", atm_dspl_nc           )
         print ( "atm_spl_heb           = ", atm_spl_heb           )
         print ( "atm_dspl_eph          = ", atm_dspl_eph          )
         print ( "atm_d1_dspl_nc        = ", atm_d1_dspl_nc        )
         print ( "atm_d1_spl_heb        = ", atm_d1_spl_heb        )
         print ( "atm_d1_dspl_eph       = ", atm_d1_dspl_eph       )
...
#
    ...
    if ( mode[8:9] == "1" ):
#
# ------ Compute integral of the loading global field 
#
         filin = config.load_grid_dir + "/" + config.load_grid_pref + data_date + '.nc.bz2' 
         com_int = config.loading_integral_exe + " " + \
                   "1 " + \
                   filin + " " + \
                   config.aam_ls_mask + " > " + \
                   config.load_int_dir  + "/" + config.load_grid_pref + data_date + '.txt'
         ...
         filin = config.load_d1_grid_dir + "/" + config.load_d1_grid_pref + data_date + '.nc.bz2' 
         ...
         com_d1_int = config.loading_integral_exe + " " + \
                      ...
                      filin + " " + \
                      config.aam_ls_mask + " > " + \
                      config.load_d1_int_dir  + "/" + config.load_d1_grid_pref + data_date + '.txt'
     
         if ( ivrb > 1 ): print ( "com_d1_int: " + com_d1_int )
         (ret, out) = exe ( com_d1_int, ivrb )
         if ( ret != 0 ):
...
#
              if ( config.compress_com == "lbzip2" ):
                   compr_com = "lbzip2 -c -n%d > %s" % ( num_thr, spr_file + ".bz2" )
              elif ( config.compress_com == "lbzip2_p1" ):
                   compr_com = "lbzip2 -c -n1  > %s" % (          spr_file + ".bz2" )
              elif ( config.compress_com == "lbzip1_2p1" ):
                   compr_com = "lbzip2 -1 -c -n1  > %s" % (       spr_file + ".bz2" )
              elif ( config.compress_com == "lbzip2_2p1" ):
...
#
         ...
         elif ( config.compress_com == "lbzip2_1p1" ):
