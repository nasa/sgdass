      SUBROUTINE HEO_WAHR1980 ( IPAR, TARG_TDB, UT1_M_TDB, E1, E2, DPSI, DEPS, &
     &                          E1_RATE, E2_RATE, DPSI_RATE, DEPS_RATE, &
     &                          CROSS_NUT_E3  )
! ************************************************************************
! *                                                                      *
! *   Routine  HEO_WAHR1980  computes angles of small rotation of the    *
...
! *   angles DPSI, DEPS according to the WAHR1980 nutation expansion.    *
! *   This routine computes rate of change of E1,E2 or DEPS,DPSI as well.*
! *                                                                      *
! *   Reference:                                                         *
! *   J.M. Wahr, "The forced nutations of an elliptical, rotating,       *
! *        elastic and oceanless Earth, Gepphys. J. Roy. Astron. Soc.,   *
! *        vol. 64, pp. 705-727, 1981.                                   *
! *                                                                      *
...
! *                             Unit: rad.                               *
! *                                                                      *
! *  ###  06-OCT-2003  HEO_WAHR1980  v3.1 (c) L. Petrov 05-SEP-2006 ###  *
! *                                                                      *
! ************************************************************************
      IMPLICIT   NONE
      INCLUDE   'nut_const.i'
